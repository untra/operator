...
**Premium:** launching agents into remote Coder workspaces requires a Premium license for the selected Operator configuration. Running Operator and its agents together inside one workspace remains local execution.
