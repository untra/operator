...
Zed provides MCP and ACP integration. It does not provide an Operator-managed terminal session controller; terminal sessions remain a separate configuration choice.
