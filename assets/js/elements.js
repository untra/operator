...
class BR extends HTMLElement {
  ...
  applyFilter(i) {
    ...
    if (!u)
      return;
    const o = i.toLowerCase().split(/\s+/).filter(Boolean), s = u.querySelector(`[data-view-target="${this.currentView()}"]`);
    let c = 0, f = 0;
    for (const h of u.querySelectorAll(`[${Fb}]`)) {
      const y = (h.getAttribute(Fb) ?? "").toLowerCase(), p = o.every((m) => y.includes(m));
...
function VR() {
  ...
  var K = /\/+/g;
  function D(z, V) {
    return typeof z == "object" && z !== null && z.key != null ? J("" + z.key) : V.toString(36);
  }
  function G(z) {
    switch (z.status) {
      case "fulfilled":
...
function kR() {
  return t_ || (t_ = 1, (function(t) {
    ...
    var g = [], h = [], y = 1, p = null, m = 3, b = !1, _ = !1, A = !1, w = !1, E = typeof setTimeout == "function" ? setTimeout : null, M = typeof clearTimeout == "function" ? clearTimeout : null, S = typeof setImmediate < "u" ? setImmediate : null;
    function T(N) {
    ...
    if (typeof S == "function")
      ...
      K.port1.onmessage = Y, J = function() {
        D.postMessage(null);
      };
    } else
      J = function() {
    ...
    t.unstable_IdlePriority = 5, t.unstable_ImmediatePriority = 1, t.unstable_LowPriority = 4, t.unstable_NormalPriority = 3, t.unstable_Profiling = null, t.unstable_UserBlockingPriority = 2, t.unstable_cancelCallback = function(N) {
      ...
      return le = Z + le, N = {
        ...
        expirationTime: le,
        sortIndex: -1
      }, Z > Q ? (N.sortIndex = Z, r(h, N), i(g) === null && N === i(h) && (A ? (M(R), R = -1) : A = !0, G(O, Z - Q))) : (N.sortIndex = le, r(g, N), _ || b || (_ = !0, C || (C = !0, J()))), N;
...
function IR() {
  ...
  return At.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = u, At.createPortal = function(g, h) {
    ...
    if (typeof g == "string" && h && typeof h.as == "string") {
      var y = h.as, p = f(y, h.crossOrigin), m = typeof h.integrity == "string" ? h.integrity : void 0, b = typeof h.fetchPriority == "string" ? h.fetchPriority : void 0;
      y === "style" ? u.d.S(
        g,
    ...
    if (typeof g == "string" && typeof h == "object" && h !== null && typeof h.as == "string") {
      var y = h.as, p = f(y, h.crossOrigin);
      u.d.L(g, y, {
        crossOrigin: p,
        integrity: typeof h.integrity == "string" ? h.integrity : void 0,
        nonce: typeof h.nonce == "string" ? h.nonce : void 0,
    ...
    return g(h);
  }, At.useFormState = function(g, h, y) {
    return c.H.useFormState(g, h, y);
...
` + pe + e + he;
  ...
  function Ae(e, n) {
    ...
    try {
      ...
      var v = l.DetermineComponentFrameRoot(), x = v[0], q = v[1];
      if (x && q) {
        var U = x.split(`
`), te = q.split(`
`);
...
` + l.stack;
  ...
  function ba(e, n, a) {
    ...
    if (l === 0) return 0;
    var d = 0, v = e.suspendedLanes, x = e.pingedLanes;
    e = e.warmLanes;
    var q = l & 134217727;
    return q !== 0 ? (l = q & ~v, l !== 0 ? d = Rn(l) : (x &= q, x !== 0 ? d = Rn(x) : a || (a = q & ~e, a !== 0 && (d = Rn(a))))) : (q = l & ~v, q !== 0 ? d = Rn(q) : x !== 0 ? d = Rn(x) : a || (a = l & ~e, a !== 0 && (d = Rn(a)))), d === 0 ? 0 : n !== 0 && n !== d && (n & v) === 0 && (v = d & -d, a = n & -n, v >= a || v === 32 && (a & 4194048) !== 0) ? n : d;
  }
  function Lr(e, n) {
  ...
  function ws(e, n, a, l, d, v) {
    ...
    l !== 0 && Fu(e, l, 0), v !== 0 && d === 0 && e.tag !== 0 && (e.suspendedLanes |= v & ~(x & ~n));
  }
  function Fu(e, n, a) {
  ...
  function Mi(e, n, a, l, d, v, x, q) {
    e.name = "", x != null && typeof x != "function" && typeof x != "symbol" && typeof x != "boolean" ? e.type = x : e.removeAttribute("type"), n != null ? x === "number" ? (n === 0 && e.value === "" || e.value != n) && (e.value = "" + Rt(n)) : e.value !== "" + Rt(n) && (e.value = "" + Rt(n)) : x !== "submit" && x !== "reset" || e.removeAttribute("value"), n != null ? qi(e, x, Rt(n)) : a != null ? qi(e, x, Rt(a)) : l != null && e.removeAttribute("value"), d == null && v != null && (e.defaultChecked = !!v), d != null && (e.checked = d && typeof d != "function" && typeof d != "symbol"), q != null && typeof q != "function" && typeof q != "symbol" && typeof q != "boolean" ? e.name = "" + Rt(q) : e.removeAttribute("name");
  }
  function wa(e, n, a, l, d, v, x, q) {
  ...
  function _m() {
    if (sl) return sl;
    var e, n = Ds, a = n.length, l, d = "value" in or ? or.value : or.textContent, v = d.length;
    for (e = 0; e < a && n[e] === d[e]; e++) ;
    var x = a - e;
    for (l = 1; l <= x && n[a - l] === d[v - l]; l++) ;
  ...
  function Ot(e) {
    function n(a, l, d, v, x) {
      this._reactName = a, this._targetInst = d, this.type = l, this.nativeEvent = v, this.target = x, this.currentTarget = null;
      for (var q in e)
        e.hasOwnProperty(q) && (a = e[q], this[q] = a ? a(v) : v[q]);
      return this.isDefaultPrevented = (v.defaultPrevented != null ? v.defaultPrevented : v.returnValue === !1) ? fl : xm, this.isPropagationStopped = xm, this;
    }
  ...
  function Km(e, n, a) {
    ...
    for (var d = !1, v = e.return; v !== null; )
      v.childLanes |= a, l = v.alternate, l !== null && (l.childLanes |= a), v.tag === 22 && (e = v.stateNode, e === null || e._visibility & 1 || (d = !0)), e = v, v = v.return;
    return e.tag === 3 ? (v = e.stateNode, d && n !== null && (d = 31 - Mt(a), e = v.hiddenUpdates, l = e[d], l === null ? e[d] = [n] : l.push(n), n.lane = a | 536870912), v) : null;
  }
  function ml(e) {
    if (50 < uu)
  ...
  function bl(e, n, a, l, d, v) {
    ...
    if (l = e, typeof e == "function") $s(e) && (x = 1);
      ...
      e: switch (e) {
        case B:
          return e = Vt(31, a, n, d), e.elementType = B, e.lanes = v, e;
        case A:
          return Xr(a.children, d, v, n);
        case w:
          x = 8, d |= 24;
          break;
        case E:
          return e = Vt(12, a, n, d | 2), e.elementType = E, e.lanes = v, e;
        case O:
          return e = Vt(13, a, n, d), e.elementType = O, e.lanes = v, e;
        case C:
          return e = Vt(19, a, n, d), e.elementType = C, e.lanes = v, e;
        default:
    ...
    return n = Vt(x, a, n, d), n.elementType = e, n.type = l, n.lanes = v, n;
  }
  function Xr(e, n, a, l) {
  ...
  function Pm(e, n, a) {
    ...
    if (30 < v) {
      var x = d - d % 5;
      v = (l & (1 << x) - 1).toString(32), l >>= x, d -= x, _n = 1 << 32 - Mt(n) + d | a << d | l, xn = v + e;
    } else
      _n = 1 << v | a << d | l, xn = e;
  }
  function Ps(e) {
      ...
      if (v !== null) {
        ...
        e: for (; v !== null; ) {
          ...
          for (var U = 0; U < n.length; U++)
            if (q.context === n[U]) {
              v.lanes |= a, q = v.alternate, q !== null && (q.lanes |= a), rc(
                v.return,
                a,
                e
              ), l || (x = null);
        ...
        x.lanes |= a, v = x.alternate, v !== null && (v.lanes |= a), rc(x, a, e), x = null;
      } else x = d.child;
  ...
  function c0(e) {
    ...
    function ye($, k, ee, ce) {
      for (var Se = null, De = null, be = k, Me = k = 0, Ne = null; be !== null && Me < ee.length; Me++) {
        ...
        e && be && He.alternate === null && n($, be), k = v(He, k, Me), De === null ? Se = He : De.sibling = He, De = He, be = Ne;
      }
      if (Me === ee.length)
        return a($, be), Oe && Ln($, Me), Se;
      if (be === null) {
        for (; Me < ee.length; Me++)
          be = fe($, ee[Me], ce), be !== null && (k = v(
            be,
            k,
            Me
    ...
    function Ee($, k, ee, ce) {
      ...
      for (var Se = null, De = null, be = k, Me = k = 0, Ne = null, He = ee.next(); be !== null && !He.done; Me++, He = ee.next()) {
        ...
        e && be && Rr.alternate === null && n($, be), k = v(Rr, k, Me), De === null ? Se = Rr : De.sibling = Rr, De = Rr, be = Ne;
      }
      if (He.done)
        return a($, be), Oe && Ln($, Me), Se;
      if (be === null) {
        for (; !He.done; Me++, He = ee.next())
          He = fe($, He.value, ce), He !== null && (k = v(He, k, Me), De === null ? Se = He : De.sibling = He, De = He);
        return Oe && Ln($, Me), Se;
      }
      for (be = l(be); !He.done; Me++, He = ee.next())
        He = ue(be, $, Me, He.value, ce), He !== null && (e && He.alternate !== null && be.delete(He.key === null ? Me : He.key), k = v(He, k, Me), De === null ? Se = He : De.sibling = He, De = He);
    ...
    function Ve($, k, ee, ce) {
      if (typeof ee == "object" && ee !== null && ee.type === A && ee.key === null && (ee = ee.props.children), typeof ee == "object" && ee !== null) {
        ...
        if (J(ee)) {
          if (Se = J(ee), typeof Se != "function") throw Error(u(150));
    ...
    if (l !== null && (l = l.updateQueue, a === l)) {
      ...
      if (a = a.firstBaseUpdate, a !== null) {
        do {
          ...
          v === null ? d = v = x : v = v.next = x, a = a.next;
        } while (a !== null);
        v === null ? d = v = n : v = v.next = n;
      } else d = v = n;
      a = {
  ...
  function Zi(e, n, a, l) {
    ...
    var d = e.updateQueue;
    hr = !1;
    var v = d.firstBaseUpdate, x = d.lastBaseUpdate, q = d.shared.pending;
    if (q !== null) {
      d.shared.pending = null;
      var U = q, te = U.next;
      U.next = null, x === null ? v = te : x.next = te, x = U;
      var oe = e.alternate;
      oe !== null && (oe = oe.updateQueue, q = oe.lastBaseUpdate, q !== x && (q === null ? oe.firstBaseUpdate = te : q.next = te, oe.lastBaseUpdate = U));
    }
    if (v !== null) {
      var fe = d.baseState;
      x = 0, oe = te = U = null, q = v;
      do {
      ...
      oe === null && (U = fe), d.baseState = U, d.firstBaseUpdate = te, d.lastBaseUpdate = oe, v === null && (d.shared.lanes = 0), _r |= x, e.lanes = x, e.memoizedState = fe;
    }
  }
  function d0(e, n) {
    if (typeof e != "function")
  ...
  function pc(e, n, a, l, d, v) {
    return Un = v, Te = n, n.memoizedState = null, n.updateQueue = null, n.lanes = 0, N.H = e === null || e.memoizedState === null ? P0 : Oc, Pr = !1, v = a(l, d), Pr = !1, Ya && (v = p0(
      n,
      a,
      l,
      d
  ...
  function Sc(e, n, a) {
    ...
    var d = e.baseQueue, v = l.pending;
    if (v !== null) {
      if (d !== null) {
        var x = d.next;
        d.next = v.next, v.next = x;
      }
      n.baseQueue = d = v, l.pending = null;
    }
        ...
        if (fe !== te.lane ? (Re & fe) === fe : (Un & fe) === fe) {
          ...
          if (ne === 0)
            ...
            fe = {
              ...
              eagerState: te.eagerState,
              next: null
            }, U === null ? (q = U = fe, x = v) : U = U.next = fe, Te.lanes |= ne, _r |= ne;
          fe = te.action, Pr && a(v, fe), v = te.hasEagerState ? te.eagerState : a(v, fe);
        } else
          ne = {
            lane: fe,
            revertLane: te.revertLane,
            ...
            eagerState: te.eagerState,
            next: null
          }, U === null ? (q = U = ne, x = v) : U = U.next = ne, Te.lanes |= fe, _r |= fe;
        te = te.next;
      } while (te !== null && te !== n);
      if (U === null ? x = v : U.next = q, !Gt(v, e.memoizedState) && (lt = !0, oe && (a = ja, a !== null)))
        throw a;
      e.memoizedState = v, e.baseState = x, e.baseQueue = U, l.lastRenderedState = v;
    }
  ...
  function Ec(e) {
    ...
    var l = a.dispatch, d = a.pending, v = n.memoizedState;
    if (d !== null) {
      a.pending = null;
      var x = d = d.next;
      do
        v = e(v, x.action), x = x.next;
      while (x !== d);
      Gt(v, n.memoizedState) || (lt = !0), n.memoizedState = v, n.baseQueue === null && (n.baseState = v), a.lastRenderedState = v;
    }
    return [v, l];
  }
  function m0(e, n, a) {
  ...
  function TC(e, n, a, l, d) {
    ...
    if (e = n.action, e !== null) {
      ...
      N.T !== null ? a(!0) : v.isTransition = !1, l(v), a = n.pending, a === null ? (v.next = n.pending = v, A0(n, v)) : (v.next = a.next, n.pending = a.next = v);
    }
  }
  function A0(e, n) {
    ...
    if (n.isTransition) {
      ...
      try {
        ...
        v !== null && x.types !== null && (v.types = x.types), N.T = v;
      }
    } else
      try {
        v = a(d, l), T0(e, n, v);
      ...
      if (a !== null) {
        e: {
          ...
          if (Oe) {
            if (Xe) {
              t: {
                for (var d = Xe, v = Wt; d.nodeType !== 8; ) {
                  if (!v) {
                    d = null;
                    break t;
                  }
  ...
  function Ll(e, n, a, l) {
    ...
    Ue !== null && l !== null && yc(l, Ue.memoizedState.deps) ? d.memoizedState = Xa(n, v, a, l) : (Te.flags |= e, d.memoizedState = Xa(
      1 | n,
      v,
      a,
      l
  ...
  function X0(e, n, a, l, d) {
    ...
    try {
      ...
      j.p = v, x !== null && q.types !== null && (x.types = q.types), N.T = x;
    }
  }
  function CC() {
  }
  ...
  function Fi(e, n, a, l) {
    ...
    if (Bl(e)) F0(n, d);
      ...
      if (e.lanes === 0 && (v === null || v.lanes === 0) && (v = n.lastRenderedReducer, v !== null))
        try {
          var x = n.lastRenderedState, q = v(x, a);
  ...
  var P0 = {
    ...
    useSyncExternalStore: function(e, n, a) {
      ...
      return d.queue = v, H0(x0.bind(null, l, v, e), [
        e
      ]), l.flags |= 2048, Xa(
        9,
        { destroy: void 0 },
  ...
  function e1(e, n, a, l, d, v, x) {
    return e = e.stateNode, typeof e.shouldComponentUpdate == "function" ? e.shouldComponentUpdate(l, v, x) : n.prototype && n.prototype.isPureReactComponent ? !Bi(a, l) || !Bi(d, v) : !0;
  }
  function t1(e, n, a, l) {
  ...
  function OC(e, n, a, l, d) {
    ...
    var v = Error(u(520), { cause: l });
    if (v = Ft(v, a), iu === null ? iu = [v] : iu.push(v), et !== 4 && (et = 2), n === null) return !0;
    l = Ft(l, a), a = n;
    do {
      switch (a.tag) {
        case 3:
        ...
        case 1:
          if (n = a.type, v = a.stateNode, (a.flags & 128) === 0 && (typeof n.getDerivedStateFromError == "function" || v !== null && typeof v.componentDidCatch == "function" && (xr === null || !xr.has(v))))
  ...
  function s1(e, n, a, l, d) {
    if (e === null) {
      var v = a.type;
      return typeof v == "function" && !$s(v) && v.defaultProps === void 0 && a.compare === null ? (n.tag = 15, n.type = v, c1(
        e,
        n,
        v,
        l,
    ...
    return n.flags |= 1, e = Hn(v, l), e.ref = n.ref, e.return = n, n.child = e;
  }
  function c1(e, n, a, l, d) {
    if (e !== null) {
      var v = e.memoizedProps;
      if (Bi(v, l) && e.ref === n.ref)
        if (lt = !1, n.pendingProps = l = v, Xc(e, d))
  ...
  function f1(e, n, a, l) {
    var d = l.children, v = e !== null ? e.memoizedState : null;
    if (e === null && n.stateNode === null && (n.stateNode = {
      ...
      if ((n.flags & 128) !== 0) {
        if (v = v !== null ? v.baseLanes | a : a, e !== null) {
      ...
      v !== null ? (El(n, v.cachePool), g0(n, v), pr(), n.memoizedState = null) : (e !== null && El(n, null), hc(), pr());
  ...
  function d1(e, n, a, l, d) {
    var v = lc();
    return v = v === null ? null : { parent: it._currentValue, pool: v }, n.memoizedState = {
      baseLanes: a,
      cachePool: v
  ...
  function zC(e, n, a) {
    ...
    if (v !== null) {
      ...
      if (vc(n), d)
        ...
        if (l = Ye, l !== null && (x = Pu(l, a), x !== 0 && x !== v.retryLane))
          throw v.retryLane = x, kr(e, x), Bt(l, e, x), Lc;
        Fl(), n = h1(
          e,
          n,
          a
        ...
        e = v.treeContext, Xe = tn(x.nextSibling), pt = n, Oe = !0, cr = null, Wt = !1, e !== null && Wm(n, e), n = Ul(n, l), n.flags |= 4096;
      return n;
    }
    return e = Hn(e.child, {
      mode: l.mode,
  ...
  function g1(e, n, a, l, d, v) {
    return Zr(n), n.updateQueue = null, a = p0(
      n,
      l,
      a,
      d
    ), y0(e), l = mc(), e !== null && !lt ? (bc(e, n, v), Vn(e, n, v)) : (Oe && l && Ps(n), n.flags |= 1, bt(e, n, a, v), n.child);
  }
  function v1(e, n, a, l, d) {
    if (Zr(n), n.stateNode === null) {
      var v = Oa, x = a.contextType;
      typeof x == "object" && x !== null && (v = mt(x)), v = new a(l, v), n.memoizedState = v.state !== null && v.state !== void 0 ? v.state : null, v.updater = Dc, n.stateNode = v, v._reactInternals = n, v = n.stateNode, v.props = l, v.state = n.memoizedState, v.refs = {}, sc(n), x = a.contextType, v.context = typeof x == "object" && x !== null ? mt(x) : Oa, v.state = n.memoizedState, x = a.getDerivedStateFromProps, typeof x == "function" && (zc(
        n,
        a,
        x,
        l
      ), v.state = n.memoizedState), typeof a.getDerivedStateFromProps == "function" || typeof v.getSnapshotBeforeUpdate == "function" || typeof v.UNSAFE_componentWillMount != "function" && typeof v.componentWillMount != "function" || (x = v.state, typeof v.componentWillMount == "function" && v.componentWillMount(), typeof v.UNSAFE_componentWillMount == "function" && v.UNSAFE_componentWillMount(), x !== v.state && Dc.enqueueReplaceState(v, v.state, null), Zi(n, l, v, d), Qi(), v.state = n.memoizedState), typeof v.componentDidMount == "function" && (n.flags |= 4194308), l = !0;
    } else if (e === null) {
      v = n.stateNode;
      var q = n.memoizedProps, U = Wr(a, q);
      v.props = U;
      var te = v.context, oe = a.contextType;
      x = Oa, typeof oe == "object" && oe !== null && (x = mt(oe));
      var fe = a.getDerivedStateFromProps;
      oe = typeof fe == "function" || typeof v.getSnapshotBeforeUpdate == "function", q = n.pendingProps !== q, oe || typeof v.UNSAFE_componentWillReceiveProps != "function" && typeof v.componentWillReceiveProps != "function" || (q || te !== x) && t1(
        n,
        v,
        l,
        x
      ...
      v.state = ne, Zi(n, l, v, d), Qi(), te = n.memoizedState, q || ne !== te || hr ? (typeof fe == "function" && (zc(
        n,
        a,
        fe,
        l
        ...
        te,
        x
      )) ? (oe || typeof v.UNSAFE_componentWillMount != "function" && typeof v.componentWillMount != "function" || (typeof v.componentWillMount == "function" && v.componentWillMount(), typeof v.UNSAFE_componentWillMount == "function" && v.UNSAFE_componentWillMount()), typeof v.componentDidMount == "function" && (n.flags |= 4194308)) : (typeof v.componentDidMount == "function" && (n.flags |= 4194308), n.memoizedProps = l, n.memoizedState = te), v.props = l, v.state = te, v.context = x, l = U) : (typeof v.componentDidMount == "function" && (n.flags |= 4194308), l = !1);
    } else {
      v = n.stateNode, cc(e, n), x = n.memoizedProps, oe = Wr(a, x), v.props = oe, fe = n.pendingProps, ne = v.context, te = a.contextType, U = Oa, typeof te == "object" && te !== null && (U = mt(te)), q = a.getDerivedStateFromProps, (te = typeof q == "function" || typeof v.getSnapshotBeforeUpdate == "function") || typeof v.UNSAFE_componentWillReceiveProps != "function" && typeof v.componentWillReceiveProps != "function" || (x !== fe || ne !== U) && t1(
        n,
        v,
        l,
        U
      ), hr = !1, ne = n.memoizedState, v.state = ne, Zi(n, l, v, d), Qi();
      ...
      x !== fe || ne !== ue || hr || e !== null && e.dependencies !== null && xl(e.dependencies) ? (typeof q == "function" && (zc(
        ...
        ue,
        U
      ) || e !== null && e.dependencies !== null && xl(e.dependencies)) ? (te || typeof v.UNSAFE_componentWillUpdate != "function" && typeof v.componentWillUpdate != "function" || (typeof v.componentWillUpdate == "function" && v.componentWillUpdate(l, ue, U), typeof v.UNSAFE_componentWillUpdate == "function" && v.UNSAFE_componentWillUpdate(
        l,
        ue,
        U
      )), typeof v.componentDidUpdate == "function" && (n.flags |= 4), typeof v.getSnapshotBeforeUpdate == "function" && (n.flags |= 1024)) : (typeof v.componentDidUpdate != "function" || x === e.memoizedProps && ne === e.memoizedState || (n.flags |= 4), typeof v.getSnapshotBeforeUpdate != "function" || x === e.memoizedProps && ne === e.memoizedState || (n.flags |= 1024), n.memoizedProps = l, n.memoizedState = ue), v.props = l, v.state = ue, v.context = U, l = oe) : (typeof v.componentDidUpdate != "function" || x === e.memoizedProps && ne === e.memoizedState || (n.flags |= 4), typeof v.getSnapshotBeforeUpdate != "function" || x === e.memoizedProps && ne === e.memoizedState || (n.flags |= 1024), l = !1);
    }
    return v = l, Gl(e, n), l = (n.flags & 128) !== 0, v || l ? (v = n.stateNode, a = l && typeof a.getDerivedStateFromError != "function" ? null : v.render(), n.flags |= 1, e !== null && l ? (n.child = Jr(
      n,
      e.child,
      null,
      d
      ...
      a,
      d
    )) : bt(e, n, a, d), n.memoizedState = v.state, e = n.child) : e = Vn(
      e,
      n,
      d
    ), e;
  ...
  function p1(e, n, a) {
    var l = n.pendingProps, d = !1, v = (n.flags & 128) !== 0, x;
    if ((x = v) || (x = e !== null && e.memoizedState === null ? !1 : (nt.current & 2) !== 0), x && (d = !0, n.flags &= -129), x = (n.flags & 32) !== 0, n.flags &= -33, e === null) {
      if (Oe) {
  ...
  function kc(e, n, a, l, d, v) {
    ...
    x === null ? e.memoizedState = {
      ...
      tailMode: d,
      treeForkCount: v
    } : (x.isBackwards = n, x.rendering = null, x.renderingStartTime = 0, x.last = l, x.tail = a, x.tailMode = d, x.treeForkCount = v);
  }
  function b1(e, n, a) {
    var l = n.pendingProps, d = l.revealOrder, v = l.tail;
    l = l.children;
    ...
    switch (n.lanes = 0, n.tag) {
      ...
      case 3:
        e: {
          ...
          d = v.element, cc(e, n), Zi(n, l, null, a);
          var x = n.memoizedState;
          if (l = x.cache, dr(n, it, l), l !== v.cache && ac(
            n,
            [it],
            a,
            !0
          ), Qi(), l = x.element, v.isDehydrated)
            if (v = {
              element: l,
              isDehydrated: !1,
              cache: x.cache
      ...
      case 5:
        return e === null && Oe && ((d = l = Xe) && (l = cR(
          ...
          n.pendingProps,
          Wt
        ), l !== null ? (n.stateNode = l, pt = n, Xe = tn(l.firstChild), Wt = !1, d = !0) : d = !1), d || fr(n)), de(n), d = n.type, v = n.pendingProps, x = e !== null ? e.memoizedProps : null, l = v.children, bf(d, v) ? l = null : x !== null && bf(d, x) && (n.flags |= 32), n.memoizedState !== null && (d = pc(
          e,
          n,
          AC,
          null,
      ...
      case 24:
        return Zr(n), l = mt(it), e === null ? (d = lc(), d === null && (d = Ye, v = ic(), d.pooledCache = v, v.refCount++, v !== null && (d.pooledCacheLanes |= a), d = v), n.memoizedState = { parent: l, cache: d }, sc(n), dr(n, it, d)) : ((e.lanes & a) !== 0 && (cc(e, n), Zi(n, null, null, a), Qi()), d = e.memoizedState, v = n.memoizedState, d.parent !== l ? (d = { parent: l, cache: l }, n.memoizedState = d, n.lanes === 0 && (n.memoizedState = n.updateQueue.baseState = d), dr(n, it, l)) : (l = v.cache, dr(n, it, l), l !== d.cache && ac(
          n,
          [it],
          a,
          !0
  ...
  function HC(e, n, a) {
    ...
    switch (Ws(n), n.tag) {
      ...
      case 26:
        var d = n.type, v = n.memoizedState;
        return e === null ? (Yn(n), v !== null ? (Ie(n), x1(n, v)) : (Ie(n), Ic(
          n,
          d,
          null,
          l,
          a
        ))) : v ? v !== e.memoizedState ? (Yn(n), Ie(n), x1(n, v)) : (Ie(n), n.flags &= -16777217) : (e = e.memoizedProps, e !== l && Yn(n), Ie(n), Ic(
          n,
          d,
          e,
          l,
              ...
              default:
                switch (d) {
                  ...
                  case "math":
                    ...
                    break;
                  case "script":
                    v = x.createElement("div"), v.innerHTML = "<script><\/script>", v = v.removeChild(
                      v.firstChild
                    );
                    break;
                  case "select":
                    v = typeof l.is == "string" ? x.createElement("select", {
                      is: l.is
                    }) : x.createElement("select"), l.multiple ? v.multiple = !0 : l.size && (v.size = l.size);
                    break;
                  default:
                    v = typeof l.is == "string" ? x.createElement(d, { is: l.is }) : x.createElement(d);
                }
            }
            v[dt] = n, v[wt] = l;
      ...
      case 13:
        ...
        return kt(n), (n.flags & 128) !== 0 ? (n.lanes = a, n) : (a = l !== null, e = e !== null && e.memoizedState !== null, a && (l = n.child, d = null, l.alternate !== null && l.alternate.memoizedState !== null && l.alternate.memoizedState.cachePool !== null && (d = l.alternate.memoizedState.cachePool.pool), v = null, l.memoizedState !== null && l.memoizedState.cachePool !== null && (v = l.memoizedState.cachePool.pool), v !== d && (l.flags |= 2048)), a !== e && a && (n.child.flags |= 8192), Yl(n, n.updateQueue), Ie(n), null);
      case 4:
      ...
      case 19:
        ...
        if (d = (n.flags & 128) !== 0, v = l.rendering, v === null)
          if (d) Wi(l, !1);
          else {
            if (et !== 0 || e !== null && (e.flags & 128) !== 0)
              for (e = n.child; e !== null; ) {
                if (v = Cl(e), v !== null) {
                  for (n.flags |= 128, Wi(l, !1), e = v.updateQueue, n.updateQueue = e, Yl(n, e), n.subtreeFlags = 0, e = a, a = n.child; a !== null; )
                    $m(a, e), a = a.sibling;
                  return ie(
                    nt,
                    nt.current & 1 | 2
          ...
          if (!d)
            if (e = Cl(v), e !== null) {
              if (n.flags |= 128, d = !0, e = e.updateQueue, n.updateQueue = e, Yl(n, e), Wi(l, !0), l.tail === null && l.tailMode === "hidden" && !v.alternate && !Oe)
                return Ie(n), null;
            } else
              2 * ke() - l.renderingStartTime > Zl && a !== 536870912 && (n.flags |= 128, d = !0, Wi(l, !1), n.lanes = 4194304);
          l.isBackwards ? (v.sibling = n.child, n.child = v) : (e = l.last, e !== null ? e.sibling = v : n.child = v, l.last = v);
        }
  ...
  function BC(e, n) {
    if (e = e.containerInfo, pf = co, e = Gm(e), Ys(e)) {
      if ("selectionStart" in e)
        ...
        e: {
          ...
          if (l && l.rangeCount !== 0) {
            a = l.anchorNode;
            var d = l.anchorOffset, v = l.focusNode;
            l = l.focusOffset;
            try {
            ...
            t: for (; ; ) {
              for (var ue; fe !== a || d !== 0 && fe.nodeType !== 3 || (q = x + d), fe !== v || l !== 0 && fe.nodeType !== 3 || (U = x + l), fe.nodeType === 3 && (x += fe.nodeValue.length), (ue = fe.firstChild) !== null; )
                ne = fe, fe = ue;
              for (; ; ) {
                if (fe === e) break t;
                if (ne === a && ++te === d && (q = x), ne === v && ++oe === l && (U = x), (ue = fe.nextSibling) !== null) break;
    ...
    for (mf = { focusedElem: e, selectionRange: a }, co = !1, yt = n; yt !== null; )
      if (n = yt, e = n.child, (n.subtreeFlags & 1028) !== 0 && e !== null)
        ...
        for (; yt !== null; ) {
          switch (n = yt, v = n.alternate, e = n.flags, n.tag) {
            case 0:
            ...
            case 1:
              if ((e & 1024) !== 0 && v !== null) {
                e = void 0, a = n, d = v.memoizedProps, v = v.memoizedState, l = a.stateNode;
                try {
                  var ye = Wr(
                    a.type,
                    d
  ...
  function Dt(e, n) {
    ...
    if (a !== null)
      for (var l = 0; l < a.length; l++) {
        ...
        N1(v, x, d), Ke = null, zt = !1, v = d.alternate, v !== null && (v.return = null), d.return = null;
      }
      ...
      case 26:
        ...
        if (Dt(n, e), Ht(e), l & 512 && (ot || a === null || Sn(a, a.return)), l & 4) {
          ...
          if (l = e.memoizedState, a === null)
            if (l === null)
              if (e.stateNode === null) {
                e: {
                  ...
                  t: switch (l) {
                    case "title":
                      v = d.getElementsByTagName("title")[0], (!v || v[jr] || v[dt] || v.namespaceURI === "http://www.w3.org/2000/svg" || v.hasAttribute("itemprop")) && (v = d.createElement(l), d.head.insertBefore(
                        v,
                        d.querySelector("head > title")
                      )), _t(v, l, a), v[dt] = e, at(v), l = v;
                      break e;
                    case "link":
                      var x = Db(
                        "link",
                      ...
                      if (x) {
                        for (var q = 0; q < x.length; q++)
                          if (v = x[q], v.getAttribute("href") === (a.href == null || a.href === "" ? null : a.href) && v.getAttribute("rel") === (a.rel == null ? null : a.rel) && v.getAttribute("title") === (a.title == null ? null : a.title) && v.getAttribute("crossorigin") === (a.crossOrigin == null ? null : a.crossOrigin)) {
                            x.splice(q, 1);
                            break t;
                          }
                      }
                      v = d.createElement(l), _t(v, l, a), d.head.appendChild(v);
                      break;
                    case "meta":
                      if (x = Db(
                        "meta",
                        ...
                        for (q = 0; q < x.length; q++)
                          if (v = x[q], v.getAttribute("content") === (a.content == null ? null : "" + a.content) && v.getAttribute("name") === (a.name == null ? null : a.name) && v.getAttribute("property") === (a.property == null ? null : a.property) && v.getAttribute("http-equiv") === (a.httpEquiv == null ? null : a.httpEquiv) && v.getAttribute("charset") === (a.charSet == null ? null : a.charSet)) {
                            x.splice(q, 1);
                            break t;
                          }
                      }
            ...
            v !== l ? (v === null ? a.stateNode !== null && (a = a.stateNode, a.parentNode.removeChild(a)) : v.count--, l === null ? Hb(
              d,
              e.type,
              e.stateNode
            ) : zb(
          ...
          e: for (n = e.stateNode, n._visibility = d ? n._visibility & -2 : n._visibility | 1, d && (a === null || U || kn || ot || ea(e)), a = null, n = e; ; ) {
            if (n.tag === 5 || n.tag === 26) {
              if (a === null) {
                ...
                try {
                  if (v = U.stateNode, d)
                    x = v.style, typeof x.setProperty == "function" ? x.setProperty("display", "none", "important") : x.display = "none";
                  else {
                    q = U.stateNode;
  ...
  function Qn(e, n, a) {
    for (a = a && (n.subtreeFlags & 8772) !== 0, n = n.child; n !== null; ) {
      var l = n.alternate, d = e, v = n, x = v.flags;
      switch (v.tag) {
        case 0:
        case 11:
        case 15:
        ...
        case 1:
          if (Qn(
            ...
            v,
            a
          ), l = v, d = l.stateNode, typeof d.componentDidMount == "function")
            try {
              d.componentDidMount();
            } catch (te) {
              je(l, l.return, te);
            }
          if (l = v, d = l.updateQueue, d !== null) {
            var q = l.stateNode;
            try {
        ...
        case 5:
          Qn(
            ...
            v,
            a
          ), a && l === null && x & 4 && A1(v), tu(v, v.return);
          break;
        case 12:
          Qn(
            d,
    ...
    switch (n.tag) {
      ...
      case 12:
        if (d & 2048) {
          ...
          try {
            var v = n.memoizedProps, x = v.id, q = v.onPostCommit;
            typeof q == "function" && q(
              x,
      ...
      case 23:
        break;
      case 22:
        v = n.stateNode, x = n.alternate, n.memoizedState !== null ? v._visibility & 2 ? sn(
          e,
          n,
          a,
          l
        ) : nu(e, n) : v._visibility & 2 ? sn(
          e,
          n,
          a,
          l
  ...
  function Ia(e, n, a, l, d) {
    for (d = d && ((n.subtreeFlags & 10256) !== 0 || !1), n = n.child; n !== null; ) {
      var v = e, x = n, q = a, U = l, te = x.flags;
      switch (x.tag) {
        case 0:
        case 11:
        case 15:
  ...
  function X1(e, n, a) {
    ...
    var l = !a && (n & 127) === 0 && (n & e.expiredLanes) === 0 || Lr(e, n), d = l ? kC(e, n) : uf(e, n, !0), v = l;
    do {
      if (d === 0) {
        Za && !l && Er(e, n, 0, !1);
        break;
      } else {
        if (a = e.current.alternate, v && !VC(a)) {
          d = uf(e, n, !1), v = !1;
          continue;
        }
        if (d === 2) {
          ...
          if (x !== 0) {
            ...
            e: {
              ...
              if (U && (Fa(q, x).flags |= 256), x = uf(
                ...
                if (Pc && !U) {
                  q.errorRecoveryDisabledLanes |= v, ta |= v, d = 4;
                  break e;
                }
                v = Lt, Lt = d, v !== null && (Lt === null ? Lt = v : Lt.push.apply(
                  Lt,
                  v
                ));
              }
  ...
  function I1(e, n, a, l, d, v, x, q, U, te, oe, fe, ne, ue) {
    if (e.timeoutHandle = -1, fe = n.subtreeFlags, fe & 8192 || (fe & 16785408) === 16785408) {
      ...
      var ye = (v & 62914560) === v ? Ql - ke() : (v & 4194048) === v ? V1 - ke() : 0;
      if (ye = AR(
        fe,
        ye
      ), ye !== null) {
        Kn = v, e.cancelPendingCommit = ye(
          W1.bind(
            null,
            e,
            n,
  ...
  function uf(e, n, a) {
    ...
    while (!0);
    return n && e.shellSuspendCounter++, Bn = Qr = null, Le = l, N.H = d, N.A = v, qe === null && (Ye = null, Re = 0, yl()), x;
  }
  function YC() {
    for (; qe !== null; ) F1(qe);
  }
        ...
        if (Be !== 0 && qe !== null) {
          ...
          t: switch (Be) {
            ...
            case 4:
              ...
              break e;
            case 7:
              u0(v) ? (Be = 0, Xt = null, J1(n)) : (Be = 0, Xt = null, Ja(e, n, v, 7));
              break;
            case 5:
              var x = null;
              switch (qe.tag) {
              ...
              Be = 0, Xt = null, Ja(e, n, v, 5);
              break;
            case 6:
              Be = 0, Xt = null, Ja(e, n, v, 6);
              break;
            case 8:
              af(), et = 6;
              break e;
  ...
  function W1(e, n, a, l, d, v, x, q, U) {
    ...
    if (n !== null) {
      ...
      if (v = n.lanes | n.childLanes, v |= Zs, ws(
        e,
        a,
        v,
        x,
        q,
        U
      ), e === Ye && (qe = Ye = null, Re = 0), $a = n, Sr = e, Kn = a, tf = v, nf = d, Y1 = l, (n.subtreeFlags & 10256) !== 0 || (n.flags & 10256) !== 0 ? (e.callbackNode = null, e.callbackPriority = 0, KC(ft, function() {
        return ab(), null;
  ...
  function eb() {
    if (ht === 1) {
      ...
      if ((n.subtreeFlags & 13878) !== 0 || a) {
        ...
        try {
          D1(n, e);
          var v = mf, x = Gm(e.containerInfo), q = v.focusedElem, U = v.selectionRange;
  ...
  function nb() {
    if (ht === 4 || ht === 3) {
      ...
      if (l !== null) {
        ...
        try {
          for (var v = e.onRecoverableError, x = 0; x < l.length; x++) {
            var q = l[x];
            v(q.value, {
        ...
        for (var a = !1, l = Wl; l !== null; ) {
          if (e !== 0) {
            ...
            if (d === 0) var v = 0;
              ...
              v = (1 << 31 - Mt(42 | e) + 1) - 1, v &= d & ~(x & ~q), v = v & 201326741 ? v & 201326741 | 1 : v ? v | 2 : 0;
            }
            v !== 0 && (a = !0, cb(l, v));
          } else
            v = Re, v = ba(
  ...
  function lb() {
    ...
    for (var n = ke(), a = null, l = Wl; l !== null; ) {
      var d = l.next, v = ob(l, n);
      v === 0 ? (l.next = null, a === null ? Wl = d : a.next = d, d === null && (Pa = a)) : (a = l, (e !== 0 || (v & 3) !== 0) && (eo = !0)), l = d;
    }
    ht !== 0 && ht !== 5 || lu(e), wr !== 0 && (wr = 0);
  }
  function ob(e, n) {
    for (var a = e.suspendedLanes, l = e.pingedLanes, d = e.expirationTimes, v = e.pendingLanes & -62914561; 0 < v; ) {
      var x = 31 - Mt(v), q = 1 << x, U = d[x];
      U === -1 ? ((q & a) === 0 || (q & l) !== 0) && (d[x] = Es(q, n)) : U <= n && (e.expiredLanes |= q), v &= ~q;
    }
    if (n = Ye, a = Re, a = ba(
      e,
      e === n ? a : 0,
  ...
  function JC(e, n, a, l, d) {
    if (n === "submit" && a && a.stateNode === d) {
      ...
      x && (n = (n = x[wt] || null) ? fb(n.formAction) : x.getAttribute("formAction"), n !== null && (v = n, x = null));
      var q = new dl(
        "action",
        "action",
        null,
        ...
        listeners: [
          {
            ...
            listener: function() {
              if (l.defaultPrevented) {
                ...
                typeof v == "function" && (q.preventDefault(), U = x ? db(d, x) : new FormData(d), Cc(
                  a,
                  {
                    pending: !0,
                    data: U,
      ...
      e: {
        ...
        if (n)
          for (var x = l.length - 1; 0 <= x; x--) {
            ...
            if (q = q.listener, U !== v && d.isPropagationStopped())
              break e;
            v = q, d.currentTarget = te;
            try {
              v(d);
            } catch (oe) {
              vl(oe);
          ...
          for (x = 0; x < l.length; x++) {
            if (q = l[x], U = q.instance, te = q.currentTarget, q = q.listener, U !== v && d.isPropagationStopped())
              break e;
            v = q, d.currentTarget = te;
            try {
              v(d);
  ...
  function no(e, n) {
    for (var a = n + "Capture", l = []; e !== null; ) {
      ...
      if (d = d.tag, d !== 5 && d !== 26 && d !== 27 || v === null || (d = Ri(e, a), d != null && l.unshift(
        su(e, d, v)
  ...
  function vb(e, n, a, l, d) {
    for (var v = n._reactName, x = []; a !== null && a !== l; ) {
      var q = a, U = q.alternate, te = q.stateNode;
      if (q = q.tag, U !== null && U === l) break;
      q !== 5 && q !== 26 && q !== 27 || te === null || (U = te, d ? (te = Ri(a, v), te != null && x.unshift(
        su(a, te, U)
      )) : d || (te = Ri(a, v), te != null && x.push(
        su(a, te, U)
      ))), a = a.return;
    }
...
`).replace(rR, "");
    ...
    switch (a) {
      ...
      case "formAction":
        if (typeof l == "function") {
          ...
          typeof v == "function" && (a === "formAction" ? (n !== "input" && Ge(e, n, "name", d.name, d, null), Ge(
            e,
            n,
            "formEncType",
            d.formEncType,
    ...
    switch (a) {
      ...
      default:
        if (!al.hasOwnProperty(a))
          e: {
            if (a[0] === "o" && a[1] === "n" && (d = a.endsWith("Capture"), n = a.slice(2, d ? a.length - 7 : void 0), v = e[wt] || null, v = v != null ? v[a] : null, typeof v == "function" && e.removeEventListener(n, v, d), typeof l == "function")) {
              typeof v != "function" && v !== null && (a in e ? e[a] = null : e.hasAttribute(a) && e.removeAttribute(a)), e.addEventListener(n, l, d);
              break e;
            }
  ...
  function _t(e, n, a) {
    switch (n) {
      ...
      case "input":
        Ce("invalid", e);
        var q = v = x = d = null, U = null, te = null;
        for (l in a)
      ...
      case "select":
        ...
        n = v, a = x, e.multiple = !!l, n != null ? lr(e, !!l, n, !1) : a != null && lr(e, !!l, a, !0);
        return;
      case "textarea":
        Ce("invalid", e), v = d = l = null;
        for (x in a)
  ...
  function aR(e, n, a, l) {
    switch (n) {
      ...
      case "li":
        break;
      case "input":
        var d = null, v = null, x = null, q = null, U = null, te = null, oe = null;
        for (ue in a) {
          var fe = a[ue];
      ...
      case "select":
        ...
        for (d in l)
          if (v = l[d], U = a[d], l.hasOwnProperty(d) && (v != null || U != null))
            switch (d) {
              case "value":
                ne = v;
                break;
      ...
      case "textarea":
        ...
        for (x in l)
          if (d = l[x], v = a[x], l.hasOwnProperty(x) && (d != null || v != null))
            switch (x) {
              case "value":
                ne = d;
                break;
  ...
  function iR() {
    if (typeof performance.getEntriesByType == "function") {
      for (var e = 0, n = 0, a = performance.getEntriesByType("resource"), l = 0; l < a.length; l++) {
        var d = a[l], v = d.transferSize, x = d.initiatorType, q = d.duration;
        if (v && q && mb(x)) {
          ...
          if (--l, n += 8 * (v + x) / (d.duration / 1e3), e++, 10 < e) break;
        }
      }
      ...
      if (e.removeChild(a), d && d.nodeType === 8)
        if (a = d.data, a === "/$" || a === "/&") {
          ...
          for (var v = a.firstChild; v; ) {
            var x = v.nextSibling, q = v.nodeName;
            v[jr] || q === "SCRIPT" || q === "STYLE" || q === "LINK" && v.rel.toLowerCase() === "stylesheet" || a.removeChild(v), v = x;
          }
        } else
  ...
  function pR(e, n, a) {
    ...
    if (l && e && n) {
      ...
      nn.has(v) || (e = p(
        ...
        a
      ), nn.set(v, e), l.querySelector(d) !== null || n === "style" && l.querySelector(fu(v)) || n === "script" && l.querySelector(du(v)) || (n = l.createElement("link"), _t(n, "link", e), at(n), l.head.appendChild(n)));
    }
  }
  function mR(e, n) {
    $n.m(e, n);
    var a = Wa;
    if (a && e) {
      var l = n && typeof n.as == "string" ? n.as : "script", d = 'link[rel="modulepreload"][as="' + Nt(l) + '"][href="' + Nt(e) + '"]', v = d;
      switch (l) {
        case "audioworklet":
        case "paintworklet":
        case "serviceworker":
      ...
      if (!nn.has(v) && (e = p({ rel: "modulepreload", href: e }, n), nn.set(v, e), a.querySelector(d) === null)) {
        switch (l) {
          case "audioworklet":
          case "paintworklet":
          case "serviceworker":
  ...
  function bR(e, n, a) {
    ...
    var l = Wa;
    if (l && e) {
      var d = ir(l).hoistableStyles, v = ei(e);
      n = n || "default";
      var x = d.get(v);
      if (!x) {
  ...
  function _R(e, n) {
    ...
    var a = Wa;
    if (a && e) {
      var l = ir(a).hoistableScripts, d = ti(e), v = l.get(d);
      v || (v = a.querySelector(du(d)), v || (e = p({ src: e, async: !0 }, n), (n = nn.get(d)) && Tf(e, n), v = a.createElement("script"), at(v), _t(v, "link", e), a.head.appendChild(v)), v = {
        type: "script",
        instance: v,
        count: 1,
        state: null
  ...
  function xR(e, n) {
    ...
    if (a && e) {
      var l = ir(a).hoistableScripts, d = ti(e), v = l.get(d);
      v || (v = a.querySelector(du(d)), v || (e = p({ src: e, async: !0, type: "module" }, n), (n = nn.get(d)) && Tf(e, n), v = a.createElement("script"), at(v), _t(v, "link", e), a.head.appendChild(v)), v = {
        type: "script",
        instance: v,
        count: 1,
        state: null
    ...
    switch (e) {
      ...
      case "link":
        if (a.rel === "stylesheet" && typeof a.href == "string" && typeof a.precedence == "string") {
          ...
          var v = ir(
            d
          ).hoistableStyles, x = v.get(e);
          if (x || (d = d.ownerDocument || d, x = {
            type: "stylesheet",
            instance: null,
            count: 0,
            state: { loading: 0, preload: null }
          }, v.set(e, x), (v = d.querySelector(
            fu(e)
          )) && !v._p && (x.instance = v, x.state.loading = 5), nn.has(e) || (a = {
            rel: "preload",
            as: "style",
            href: a.href,
    ...
    if (n.count++, n.instance === null)
      switch (n.type) {
        ...
        case "stylesheet":
          ...
          if (v)
            return n.state.loading |= 4, n.instance = v, at(v), v;
          l = Ob(a), (d = nn.get(d)) && Af(l, d), v = (e.ownerDocument || e).createElement("link"), at(v);
          var x = v;
          return x._p = new Promise(function(q, U) {
            x.onload = q, x.onerror = U;
          }), _t(v, "link", l), n.state.loading |= 4, io(v, a.precedence, e), n.instance = v;
        case "script":
          return v = ti(a.src), (d = e.querySelector(
            du(v)
          )) ? (n.instance = d, at(d), d) : (l = a, (d = nn.get(v)) && (l = p({}, a), Tf(l, d)), e = e.ownerDocument || e, d = e.createElement("script"), at(d), _t(d, "link", l), e.head.appendChild(d), n.instance = d);
        case "void":
          return null;
        default:
  ...
  function io(e, n, a) {
    ...
    ), d = l.length ? l[l.length - 1] : null, v = d, x = 0; x < l.length; x++) {
      var q = l[x];
      if (q.dataset.precedence === n) v = q;
      else if (v !== d) break;
    }
  ...
  function Db(e, n, a) {
    ...
    for (l.set(e, null), a = a.getElementsByTagName(e), d = 0; d < a.length; d++) {
      var v = a[d];
      if (!(v[jr] || v[dt] || e === "link" && v.getAttribute("rel") === "stylesheet") && v.namespaceURI !== "http://www.w3.org/2000/svg") {
        var x = v.getAttribute(n) || "";
        x = e + x;
        var q = l.get(x);
        q ? q.push(v) : l.set(x, [v]);
      }
    }
    return l;
  }
  ...
  function wR(e, n, a, l) {
    if (a.type === "stylesheet" && (typeof l.media != "string" || matchMedia(l.media).matches !== !1) && (a.state.loading & 4) === 0) {
      if (a.instance === null) {
        var d = ei(l.href), v = n.querySelector(
          fu(d)
        );
        if (v) {
          n = v._p, n !== null && typeof n == "object" && typeof n.then == "function" && (e.count++, e = lo.bind(e), n.then(e, e)), a.state.loading |= 4, a.instance = v, at(v);
          return;
        }
        v = n.ownerDocument || n, l = Ob(l), (d = nn.get(d)) && Af(l, d), v = v.createElement("link"), at(v);
        var x = v;
        x._p = new Promise(function(q, U) {
          x.onload = q, x.onerror = U;
        }), _t(v, "link", l), a.instance = v;
      }
  ...
  function TR(e, n) {
    if (!(n.state.loading & 4)) {
      ...
      d = n.instance, x = d.getAttribute("data-precedence"), v = a.get(x) || l, v === l && a.set(null, d), a.set(x, d), this.count++, l = lo.bind(this), d.addEventListener("load", l), d.addEventListener("error", l), v ? v.parentNode.insertBefore(d, v.nextSibling) : (e = e.nodeType === 9 ? e.head : e, e.insertBefore(d, e.firstChild)), n.state.loading |= 4;
    }
  }
  var hu = {
    $$typeof: S,
  ...
  function Bb(e, n, a, l, d, v, x, q, U, te, oe, fe) {
    return e = new MR(
      e,
      n,
      a,
      ...
      fe,
      q
    ), n = 1, v === !0 && (n |= 24), v = Vt(3, null, null, n), e.current = v, v.stateNode = e, n = ic(), n.refCount++, e.pooledCache = n, n.refCount++, v.memoizedState = {
      element: l,
      isDehydrated: a,
      cache: n
    }, sc(v), e;
  ...
  function Ub(e, n, a, l, d, v) {
    d = jb(d), l.context === null ? l.context = d : l.pendingContext = d, l = gr(n), l.payload = { element: a }, v = v === void 0 ? null : v, v !== null && (l.callback = v), a = vr(e, l, n), a !== null && (Bt(a, e, n), Ii(a, e, n));
  }
  function Gb(e, n) {
              ...
              case 3:
                if (v = v.stateNode, v.current.memoizedState.isDehydrated) {
                  ...
                  if (x !== 0) {
                    ...
                    En(v), (Le & 6) === 0 && (Zl = ke() + 500, lu(0));
                  }
                }
                break;
              case 31:
              case 13:
                q = kr(v, 2), q !== null && Bt(q, v, 2), $l(), qf(v, 2);
            }
          if (v = Rf(l), v === null && vf(
            e,
            n,
  ...
  return mu.createRoot = function(e, n) {
    ...
    var a = !1, l = "", d = n1, v = r1, x = a1;
    return n != null && (n.unstable_strictMode === !0 && (a = !0), n.identifierPrefix !== void 0 && (l = n.identifierPrefix), n.onUncaughtError !== void 0 && (d = n.onUncaughtError), n.onCaughtError !== void 0 && (v = n.onCaughtError), n.onRecoverableError !== void 0 && (x = n.onRecoverableError)), n = Bb(
      e,
      1,
      !1,
      null,
    ...
    if (!o(e)) throw Error(u(299));
    var l = !1, d = "", v = n1, x = r1, q = a1, U = null;
    return a != null && (a.unstable_strictMode === !0 && (l = !0), a.identifierPrefix !== void 0 && (d = a.identifierPrefix), a.onUncaughtError !== void 0 && (v = a.onUncaughtError), a.onCaughtError !== void 0 && (x = a.onCaughtError), a.onRecoverableError !== void 0 && (q = a.onRecoverableError), a.formState !== void 0 && (U = a.formState)), n = Bb(
      e,
      1,
      !0,
      n,
...
function oN() {
  if (R_) return cd;
  R_ = 1;
  var t = ju(), r = lN(), i = rn(), u = VA(), o = /[\\^$.*+?()[\]{}|]/g, s = /^\[object .+?Constructor\]$/, c = Function.prototype, f = Object.prototype, g = c.toString, h = f.hasOwnProperty, y = RegExp(
...
function Uu() {
  ...
  function i(u, o, s, c) {
    ...
    for (var g = -1, h = o.length; ++g < h; ) {
      var y = o[g], p = c ? c(s[y], u[y], y, s, u) : void 0;
      p === void 0 && (p = u[y]), f ? r(s, y, p) : t(s, y, p);
    }
    return s;
  }
  return Hd = i, Hd;
...
function kA() {
  ...
  function g(h, y) {
    ...
    for (var M in h)
      (y || f.call(h, M)) && !(A && // Safari 9 has enumerable `arguments.length` in strict mode.
...
function mi() {
  if (Xx) return xh;
  Xx = 1;
  var t = HN(), r = zp(), i = LN(), u = PA(), o = BN(), s = fa(), c = VA(), f = "[object Map]", g = "[object Object]", h = "[object Promise]", y = "[object Set]", p = "[object WeakMap]", m = "[object DataView]", b = c(t), _ = c(r), A = c(i), w = c(u), E = c(o), M = s;
  return (t && M(new t(new ArrayBuffer(1))) != m || r && M(new r()) != f || i && M(i.resolve()) != h || u && M(new u()) != y || o && M(new o()) != p) && (M = function(S) {
...
function rT() {
  ...
  function Ae(xe, Pe, tt, xt, gt, St) {
    ...
    var _i = Ct ? vt ? y : h : vt ? O : T, va = Tt ? void 0 : _i(xe);
...
function sT() {
  ...
  function s(c, f, g, h, y, p) {
    ...
    for (p.set(c, f), p.set(f, c); ++E < b; ) {
      ...
      if (S) {
        if (!r(f, function(R, H) {
          if (!i(S, H) && (T === R || y(T, R, g, h, p)))
            return S.push(H);
        })) {
          M = !1;
          break;
        }
      } else if (!(T === O || y(T, O, g, h, p))) {
        M = !1;
        break;
      }
    }
...
function t3() {
  if (TS) return rg;
  TS = 1;
  var t = yi(), r = WA(), i = vi(), u = sT(), o = e3(), s = Ip(), c = 1, f = 2, g = "[object Boolean]", h = "[object Date]", y = "[object Error]", p = "[object Map]", m = "[object Number]", b = "[object RegExp]", _ = "[object Set]", A = "[object String]", w = "[object Symbol]", E = "[object ArrayBuffer]", M = "[object DataView]", S = t ? t.prototype : void 0, T = S ? S.valueOf : void 0;
  function O(C, R, H, B, X, Y, J) {
    switch (H) {
      case M:
...
function n3() {
  ...
  function o(s, c, f, g, h, y) {
    ...
    for (var O = p; ++w < b; ) {
      ...
      var C = s[E], R = c[E];
      if (g)
        var H = p ? g(R, C, E, c, s, y) : g(C, R, E, s, c, y);
      if (!(H === void 0 ? C === R || h(C, R, f, g, y) : H)) {
        T = !1;
        break;
      }
      O || (O = E == "constructor");
    ...
    return y.delete(s), y.delete(c), T;
  }
  return ag = o, ag;
}
var ig, qS;
function r3() {
  if (qS) return ig;
  qS = 1;
  var t = $o(), r = sT(), i = t3(), u = n3(), o = mi(), s = st(), c = pi(), f = Vu(), g = 1, h = "[object Arguments]", y = "[object Array]", p = "[object Object]", m = Object.prototype, b = m.hasOwnProperty;
  function _(A, w, E, M, S, T) {
    var O = s(A), C = s(w), R = O ? y : o(A), H = C ? y : o(w);
    R = R == h ? p : R, H = H == h ? p : H;
    ...
    if (!(E & g)) {
      var J = B && b.call(A, "__wrapped__"), K = X && b.call(w, "__wrapped__");
      if (J || K) {
        var D = J ? A.value() : A, G = K ? w.value() : w;
...
function gT() {
  ...
  function c(f, g, h) {
    g = t(g, f);
    for (var y = -1, p = g.length, m = !1; ++y < p; ) {
      var b = s(g[y]);
      if (!(m = f != null && h(f, b)))
        break;
      f = f[b];
    }
    return m || ++y != p ? m : (p = f == null ? 0 : f.length, !!p && o(p) && u(b, p) && (i(f) || r(f)));
  }
  return Ag = c, Ag;
}
var Tg, $S;
...
function h3() {
  ...
  function h(y, p) {
    return u(y) && o(p) ? s(c(y), p) : function(m) {
      var b = r(m, y);
      return b === void 0 && b === p ? i(m, y) : t(p, b, f | g);
    };
  }
  return Mg = h, Mg;
}
...
function p3() {
  if (aE) return Hg;
  aE = 1;
  var t = jp(), r = mi(), i = Gu(), u = st(), o = Wn(), s = pi(), c = es(), f = Vu(), g = "[object Map]", h = "[object Set]", y = Object.prototype, p = y.hasOwnProperty;
  function m(b) {
    if (b == null)
      return !0;
...
function ST() {
  ...
  function s(c, f, g) {
    var h = o(c) ? t : u, y = arguments.length < 3;
    return h(c, i(f, 4), g, y, r);
  }
  return Vg = s, Vg;
}
var Yg, fE;
...
function E3() {
  if (gE) return Ig;
  gE = 1;
  var t = "\\ud800-\\udfff", r = "\\u0300-\\u036f", i = "\\ufe20-\\ufe2f", u = "\\u20d0-\\u20ff", o = r + i + u, s = "\\ufe0e\\ufe0f", c = "[" + t + "]", f = "[" + o + "]", g = "\\ud83c[\\udffb-\\udfff]", h = "(?:" + f + "|" + g + ")", y = "[^" + t + "]", p = "(?:\\ud83c[\\udde6-\\uddff]){2}", m = "[\\ud800-\\udbff][\\udc00-\\udfff]", b = "\\u200d", _ = h + "?", A = "[" + s + "]?", w = "(?:" + b + "(?:" + [y, p, m].join("|") + ")" + A + _ + ")*", E = A + _ + w, M = "(?:" + [y + f + "?", f, p, m, c].join("|") + ")", S = RegExp(g + "(?=" + g + ")|" + M + E, "g");
  function T(O) {
...
function Zp() {
  ...
  function i(u, o, s, c, f) {
    ...
    for (s || (s = r), f || (f = []); ++g < h; ) {
      var y = u[g];
      o > 0 && s(y) ? o > 1 ? i(y, o - 1, s, c, f) : t(f, y) : c || (f[f.length] = y);
    }
    return f;
  }
  return Fg = i, Fg;
...
function j3() {
  ...
  function f(g, h, y) {
    ...
    e:
      for (; ++p < b; ) {
        var M = g[p], S = h ? h(M) : M;
        if (M = y || M !== 0 ? M : 0, _ && S === S) {
          for (var T = w.length; T--; )
            if (w[T] === S)
              continue e;
          h && w.push(S), A.push(M);
        } else m(w, S, y) || (w !== A && w.push(S), A.push(M));
      }
    return A;
  }
  return fv = f, fv;
...
function Kp() {
  ...
  var r = "\0", i = "\0", u = "";
  function o(y) {
    this._isDirected = t.has(y, "directed") ? y.directed : !0, this._isMultigraph = t.has(y, "multigraph") ? y.multigraph : !1, this._isCompound = t.has(y, "compound") ? y.compound : !1, this._label = void 0, this._defaultNodeLabelFn = t.constant(void 0), this._defaultEdgeLabelFn = t.constant(void 0), this._nodes = {}, this._isCompound && (this._parent = {}, this._children = {}, this._children[i] = {}), this._in = {}, this._preds = {}, this._out = {}, this._sucs = {}, this._edgeObjs = {}, this._edgeLabels = {};
  }
  o.prototype._nodeCount = 0, o.prototype._edgeCount = 0, o.prototype.isDirected = function() {
  ...
  }, o.prototype.setGraph = function(y) {
    return this._label = y, this;
  }, o.prototype.graph = function() {
    return this._label;
  }, o.prototype.setDefaultNodeLabel = function(y) {
    return t.isFunction(y) || (y = t.constant(y)), this._defaultNodeLabelFn = y, this;
    ...
    return t.filter(this.nodes(), function(p) {
      return t.isEmpty(y._in[p]);
    });
  }, o.prototype.sinks = function() {
    var y = this;
    return t.filter(this.nodes(), function(p) {
      return t.isEmpty(y._out[p]);
    });
  }, o.prototype.setNodes = function(y, p) {
    var m = arguments, b = this;
    return t.each(y, function(_) {
      m.length > 1 ? b.setNode(_, p) : b.setNode(_);
    }), this;
  }, o.prototype.setNode = function(y, p) {
    return t.has(this._nodes, y) ? (arguments.length > 1 && (this._nodes[y] = p), this) : (this._nodes[y] = arguments.length > 1 ? p : this._defaultNodeLabelFn(y), this._isCompound && (this._parent[y] = i, this._children[y] = {}, this._children[i][y] = !0), this._in[y] = {}, this._preds[y] = {}, this._out[y] = {}, this._sucs[y] = {}, ++this._nodeCount, this);
  }, o.prototype.node = function(y) {
    return this._nodes[y];
  }, o.prototype.hasNode = function(y) {
    return t.has(this._nodes, y);
  }, o.prototype.removeNode = function(y) {
    var p = this;
    if (t.has(this._nodes, y)) {
      var m = function(b) {
        p.removeEdge(p._edgeObjs[b]);
      };
      delete this._nodes[y], this._isCompound && (this._removeFromParentsChildList(y), delete this._parent[y], t.each(this.children(y), function(b) {
        p.setParent(b);
      }), delete this._children[y]), t.each(t.keys(this._in[y]), m), delete this._in[y], delete this._preds[y], t.each(t.keys(this._out[y]), m), delete this._out[y], delete this._sucs[y], --this._nodeCount;
    }
    return this;
  }, o.prototype.setParent = function(y, p) {
    if (!this._isCompound)
    ...
    if (t.isUndefined(p))
      ...
      for (var m = p; !t.isUndefined(m); m = this.parent(m))
        if (m === y)
          throw new Error("Setting " + p + " as parent of " + y + " would create a cycle");
      this.setNode(p);
    }
    return this.setNode(y), this._removeFromParentsChildList(y), this._parent[y] = p, this._children[p][y] = !0, this;
  }, o.prototype._removeFromParentsChildList = function(y) {
    delete this._children[this._parent[y]][y];
  }, o.prototype.parent = function(y) {
    if (this._isCompound) {
      var p = this._parent[y];
      if (p !== i)
        return p;
    }
  }, o.prototype.children = function(y) {
    if (t.isUndefined(y) && (y = i), this._isCompound) {
      var p = this._children[y];
      if (p)
        return t.keys(p);
    } else {
      if (y === i)
  ...
  }, o.prototype.predecessors = function(y) {
    var p = this._preds[y];
    if (p)
      return t.keys(p);
  }, o.prototype.successors = function(y) {
    var p = this._sucs[y];
    if (p)
      return t.keys(p);
  }, o.prototype.neighbors = function(y) {
    var p = this.predecessors(y);
    if (p)
      return t.union(p, this.successors(y));
  }, o.prototype.isLeaf = function(y) {
    var p;
    return this.isDirected() ? p = this.successors(y) : p = this.neighbors(y), p.length === 0;
  }, o.prototype.filterNodes = function(y) {
  ...
  }, o.prototype.setDefaultEdgeLabel = function(y) {
    return t.isFunction(y) || (y = t.constant(y)), this._defaultEdgeLabelFn = y, this;
  }, o.prototype.edgeCount = function() {
    return this._edgeCount;
  }, o.prototype.edges = function() {
    return t.values(this._edgeObjs);
  }, o.prototype.setPath = function(y, p) {
    var m = this, b = arguments;
    return t.reduce(y, function(_, A) {
      return b.length > 1 ? m.setEdge(_, A, p) : m.setEdge(_, A), A;
    }), this;
  }, o.prototype.setEdge = function() {
    var y, p, m, b, _ = !1, A = arguments[0];
    typeof A == "object" && A !== null && "v" in A ? (y = A.v, p = A.w, m = A.name, arguments.length === 2 && (b = arguments[1], _ = !0)) : (y = A, p = arguments[1], m = arguments[3], arguments.length > 2 && (b = arguments[2], _ = !0)), y = "" + y, p = "" + p, t.isUndefined(m) || (m = "" + m);
    var w = f(this._isDirected, y, p, m);
    if (t.has(this._edgeLabels, w))
      return _ && (this._edgeLabels[w] = b), this;
    if (!t.isUndefined(m) && !this._isMultigraph)
      throw new Error("Cannot set a named edge when isMultigraph = false");
    this.setNode(y), this.setNode(p), this._edgeLabels[w] = _ ? b : this._defaultEdgeLabelFn(y, p, m);
    var E = g(this._isDirected, y, p, m);
    return y = E.v, p = E.w, Object.freeze(E), this._edgeObjs[w] = E, s(this._preds[p], y), s(this._sucs[y], p), this._in[p][w] = E, this._out[y][w] = E, this._edgeCount++, this;
  }, o.prototype.edge = function(y, p, m) {
    var b = arguments.length === 1 ? h(this._isDirected, arguments[0]) : f(this._isDirected, y, p, m);
    return this._edgeLabels[b];
  }, o.prototype.hasEdge = function(y, p, m) {
    var b = arguments.length === 1 ? h(this._isDirected, arguments[0]) : f(this._isDirected, y, p, m);
    return t.has(this._edgeLabels, b);
  }, o.prototype.removeEdge = function(y, p, m) {
    var b = arguments.length === 1 ? h(this._isDirected, arguments[0]) : f(this._isDirected, y, p, m), _ = this._edgeObjs[b];
    return _ && (y = _.v, p = _.w, delete this._edgeLabels[b], delete this._edgeObjs[b], c(this._preds[p], y), c(this._sucs[y], p), delete this._in[p][b], delete this._out[y][b], this._edgeCount--), this;
  }, o.prototype.inEdges = function(y, p) {
    var m = this._in[y];
    if (m) {
      var b = t.values(m);
  ...
  }, o.prototype.outEdges = function(y, p) {
    var m = this._out[y];
    if (m) {
      var b = t.values(m);
      return p ? t.filter(b, function(_) {
  ...
  }, o.prototype.nodeEdges = function(y, p) {
    var m = this.inEdges(y, p);
    if (m)
      return m.concat(this.outEdges(y, p));
  };
  function s(y, p) {
    y[p] ? y[p]++ : y[p] = 1;
  }
...
function k3() {
  ...
  function u(c) {
    return t.map(c.nodes(), function(f) {
      var g = c.node(f), h = c.parent(f), y = { v: f };
      return t.isUndefined(g) || (y.value = g), t.isUndefined(h) || (y.parent = h), y;
    });
  }
  function o(c) {
...
function CT() {
  ...
  function o(s, c, f, g) {
    var h = {}, y = new r(), p, m, b = function(_) {
      ...
      M < w.distance && (w.distance = M, w.predecessor = p, y.decrease(A, M));
    };
    for (s.nodes().forEach(function(_) {
      var A = _ === c ? 0 : Number.POSITIVE_INFINITY;
      h[_] = { distance: A }, y.add(_, A);
    }); y.size() > 0 && (p = y.removeMin(), m = h[p], m.distance !== Number.POSITIVE_INFINITY); )
      g(p).forEach(b);
    return h;
  }
  return Ev;
  ...
  function r(i) {
    ...
    function f(g) {
      ...
      if (o.push(g), i.successors(g).forEach(function(m) {
        ...
        var y = [], p;
        do
          p = o.pop(), s[p].onStack = !1, y.push(p);
        while (g !== p);
        c.push(y);
      }
    }
...
function Z3() {
  ...
  function u(o, s, c) {
    ...
    return g.forEach(function(h) {
      f[h] = {}, f[h][h] = { distance: 0 }, g.forEach(function(y) {
        h !== y && (f[h][y] = { distance: Number.POSITIVE_INFINITY });
      }), c(h).forEach(function(y) {
        var p = y.v === h ? y.w : y.v, m = s(y);
      ...
      g.forEach(function(p) {
        ...
        g.forEach(function(b) {
          var _ = m[h], A = y[b], w = m[b], E = _.distance + A.distance;
...
function tO() {
  ...
  var t = us(), r = vi(), i = ls(), u = ha(), o = Object.prototype, s = o.hasOwnProperty, c = t(function(f, g) {
    f = Object(f);
    var h = -1, y = g.length, p = y > 2 ? g[2] : void 0;
    for (p && i(g[0], g[1], p) && (y = 1); ++h < y; )
...
function yO() {
  if (qw) return iy;
  qw = 1;
  var t = HT(), r = IA(), i = eT(), u = QA(), o = nT(), s = Gu(), c = st(), f = TT(), g = pi(), h = ju(), y = rn(), p = gO(), m = Vu(), b = LT(), _ = vO();
  function A(w, E, M, S, T, O, C) {
    ...
    if (Y) {
      var J = c(H), K = !J && g(H), D = !J && !K && m(H);
      X = H, J || K || D ? c(R) ? X = R : f(R) ? X = u(R) : K ? (Y = !1, X = r(H, !0)) : D ? (Y = !1, X = i(H, !0)) : X = [] : p(H) || s(H) ? (X = R, s(R) ? X = _(R) : (!y(R) || h(R)) && (X = o(H))) : Y = !1;
    }
...
function EO() {
  ...
  function s(c, f, g, h) {
    if (!u(c))
      return c;
    f = r(f, c);
    for (var y = -1, p = f.length, m = p - 1, b = c; b != null && ++y < p; ) {
      var _ = o(f[y]), A = g;
      if (_ === "__proto__" || _ === "constructor" || _ === "prototype")
        return c;
      if (y != m) {
        var w = b[_];
        A = h ? h(w, _, b) : void 0, A === void 0 && (A = u(w) ? w : i(f[y + 1]) ? [] : {});
      }
      t(b, _, A), b = b[_];
    }
    return c;
...
function OO() {
  ...
  function r(i, u) {
    if (i !== u) {
      var o = i !== void 0, s = i === null, c = i === i, f = t(i), g = u !== void 0, h = u === null, y = u === u, p = t(u);
      if (!h && !p && !f && i > u || f && g && y && !h && !p || s && g && y || !o && y || !c)
        return 1;
      if (!s && !f && !p && i < u || p && o && c && !s && !f || h && o && c || !g && c || !y)
        return -1;
    }
    return 0;
  }
...
function GO() {
  ...
  function o(h, y) {
    if (h.nodeCount() <= 1)
      return [];
    var p = f(h, y || u), m = s(p.graph, p.buckets, p.zeroIdx);
    return t.flatten(t.map(m, function(b) {
      return h.outEdges(b.v, b.w);
    }), !0);
  }
  function s(h, y, p) {
    for (var m = [], b = y[y.length - 1], _ = y[0], A; h.nodeCount(); ) {
      for (; A = _.dequeue(); )
        c(h, y, p, A);
      for (; A = b.dequeue(); )
        c(h, y, p, A);
      if (h.nodeCount()) {
        for (var w = y.length - 2; w > 0; --w)
          if (A = y[w].dequeue(), A) {
            m = m.concat(c(h, y, p, A, !0));
            break;
          }
      }
    }
  ...
  function f(h, y) {
    ...
    t.forEach(h.nodes(), function(w) {
      ...
      var E = p.edge(w.v, w.w) || 0, M = y(w), S = E + M;
  ...
  function g(h, y, p) {
    p.out ? p.in ? h[p.out - p.in + y].enqueue(p) : h[h.length - 1].enqueue(p) : h[0].enqueue(p);
  }
  return Ny;
}
var Oy, t2;
function VO() {
  ...
  function u(s) {
    var c = [], f = {}, g = {};
    function h(y) {
      t.has(g, y) || (g[y] = !0, f[y] = !0, t.forEach(s.outEdges(y), function(p) {
...
function YO() {
  ...
  function u(s, c) {
    var f = c.v, g = s.node(f).rank, h = c.w, y = s.node(h).rank, p = c.name, m = s.edge(c), b = m.labelRank;
    if (y !== g + 1) {
      s.removeEdge(c);
      var _, A, w;
      for (w = 0, ++g; g < y; ++w, ++g)
...
function jT() {
  ...
  Ly = u;
  function u(f) {
    var g = new r({ directed: !1 }), h = f.nodes()[0], y = f.nodeCount();
    g.setNode(h, {});
    for (var p, m; o(g, f) < y; )
  ...
  function o(f, g) {
    function h(y) {
      t.forEach(g.nodeEdges(y), function(p) {
        var m = p.v, b = y === m ? p.w : m;
        !f.hasNode(b) && !i(g, p) && (f.setNode(b, {}), f.setEdge(y, b, {}), h(b));
      });
    }
...
function kO() {
  ...
  By = f, f.initLowLimValues = p, f.initCutValues = g, f.calcCutValue = y, f.leaveEdge = b, f.enterEdge = _, f.exchangeEdges = A;
  function f(S) {
    S = c(S), u(S);
    var T = r(S);
    p(T), g(T, S);
  ...
  function _(S, T, O) {
    ...
    H.lim > B.lim && (X = B, Y = !0);
    var J = t.filter(T.edges(), function(K) {
      return Y === M(S, S.node(K.v), X) && Y !== M(S, S.node(K.w), X);
    });
    return t.minBy(J, function(K) {
      return i(T, K);
    });
  }
  function A(S, T, O, C) {
...
function IO() {
  ...
  function r(o) {
    ...
    t.forEach(o.graph().dummyChains, function(c) {
      for (var f = o.node(c), g = f.edgeObj, h = i(o, s, g.v, g.w), y = h.path, p = h.lca, m = 0, b = y[m], _ = !0; c !== g.w; ) {
        if (f = o.node(c), _) {
          for (; (b = y[m]) !== p && o.node(b).maxRank < f.rank; )
            m++;
          b === p && (_ = !1);
        }
        if (!_) {
          for (; m < y.length - 1 && o.node(b = y[m + 1]).minRank <= f.rank; )
            m++;
          b = y[m];
        }
  ...
  function i(o, s, c, f) {
    var g = [], h = [], y = Math.min(s[c].low, s[f].low), p = Math.max(s[c].lim, s[f].lim), m, b;
    m = c;
    do
      m = o.parent(m), g.push(m);
    while (m && (s[m].low > y || p > s[m].lim));
...
function QO() {
  ...
  function i(f) {
    var g = r.addDummyNode(f, "root", {}, "_root"), h = o(f), y = t.max(t.values(h)) - 1, p = 2 * y + 1;
  ...
  function u(f, g, h, y, p, m, b) {
    ...
    f.setParent(A, b), E.borderTop = A, f.setParent(w, b), E.borderBottom = w, t.forEach(_, function(M) {
      u(f, g, h, y, p, m, M);
      var S = f.node(M), T = S.borderTop ? S.borderTop : M, O = S.borderBottom ? S.borderBottom : M, C = S.borderTop ? y : 2 * y, R = T !== O ? 1 : p - m[b] + 1;
      f.setEdge(A, T, {
        weight: C,
        minlen: R,
        nestingEdge: !0
  ...
  function o(f) {
    ...
    return t.forEach(f.children(), function(y) {
      h(y, 1);
    }), g;
  }
  function s(f) {
...
function ZO() {
  ...
  function i(o) {
    function s(c) {
      ...
      if (f.length && t.forEach(f, s), t.has(g, "minRank")) {
        ...
        for (var h = g.minRank, y = g.maxRank + 1; h < y; ++h)
  ...
  function u(o, s, c, f, g, h) {
    var y = { width: 0, height: 0, rank: h, borderType: s }, p = g[s][h - 1], m = r.addDummyNode(o, "border", y, c);
...
function KO() {
  ...
  function r(h) {
    var y = h.graph().rankdir.toLowerCase();
    (y === "lr" || y === "rl") && u(h);
  }
  function i(h) {
    var y = h.graph().rankdir.toLowerCase();
    (y === "bt" || y === "rl") && s(h), (y === "lr" || y === "rl") && (f(h), u(h));
  }
  function u(h) {
    t.forEach(h.nodes(), function(y) {
      o(h.node(y));
    }), t.forEach(h.edges(), function(y) {
      o(h.edge(y));
    });
  }
  function o(h) {
    var y = h.width;
    h.width = h.height, h.height = y;
  }
  function s(h) {
    t.forEach(h.nodes(), function(y) {
      c(h.node(y));
  ...
  function r(i) {
    ...
    function f(h) {
      if (!t.has(u, h)) {
        u[h] = !0;
        var y = i.node(h);
        c[y.rank].push(h), t.forEach(i.successors(h), f);
      }
    }
...
function FO() {
  ...
  function i(u, o, s) {
    ...
    var h = 2 * g - 1;
    g -= 1;
    var y = t.map(new Array(h), function() {
      return 0;
    }), p = 0;
    return t.forEach(f.forEach(function(m) {
      ...
      y[b] += m.weight;
      for (var _ = 0; b > 0; )
        b % 2 && (_ += y[b + 1]), b = b - 1 >> 1, y[b] += m.weight;
      p += m.weight * _;
    })), p;
  }
  return Xy;
    ...
    return t.map(u, function(o) {
      ...
      if (s.length) {
        var c = t.reduce(s, function(f, g) {
          var h = i.edge(g), y = i.node(g.v);
          return {
            sum: f.sum + h.weight * y.order,
...
function PO() {
  ...
  function r(o, s) {
    ...
    t.forEach(o, function(g, h) {
      ...
      t.isUndefined(g.barycenter) || (y.barycenter = g.barycenter, y.weight = g.weight);
    }), t.forEach(s.edges(), function(g) {
      var h = c[g.v], y = c[g.w];
      !t.isUndefined(h) && !t.isUndefined(y) && (y.indegree++, h.out.push(c[g.w]));
    });
  ...
  function i(o) {
    ...
    function c(h) {
      return function(y) {
        y.merged || (t.isUndefined(y.barycenter) || t.isUndefined(h.barycenter) || y.barycenter >= h.barycenter) && u(h, y);
      };
    }
    function f(h) {
      return function(y) {
        y.in.push(h), --y.indegree === 0 && o.push(y);
      };
    }
    for (; o.length; ) {
      var g = o.pop();
...
function WO() {
  ...
  function i(s, c) {
    ...
    g.sort(o(!!c)), b = u(y, h, b), t.forEach(g, function(A) {
      b += A.vs.length, y.push(A.vs), p += A.barycenter * A.weight, m += A.weight, b = u(y, h, b);
    });
    var _ = { vs: t.flatten(y, !0) };
...
function ez() {
  ...
  function s(f, g) {
    t.forEach(f, function(h) {
      h.vs = t.flatten(h.vs.map(function(y) {
        return g[y] ? g[y].vs : y;
      }), !0);
    });
  }
...
function tz() {
  ...
  function i(o, s, c) {
    ...
    return t.forEach(o.nodes(), function(h) {
      var y = o.node(h), p = o.parent(h);
      (y.rank === s || y.minRank <= s && s <= y.maxRank) && (g.setNode(h), g.setParent(h, p || f), t.forEach(o[c](h), function(m) {
        var b = m.v === h ? m.w : m.v, _ = g.edge(b, h), A = t.isUndefined(_) ? 0 : _.weight;
        g.setEdge(b, h, { weight: o.edge(m).weight + A });
      }), t.has(y, "minRank") && g.setNode(h, {
        borderLeft: y.borderLeft[s],
        borderRight: y.borderRight[s]
      }));
    }), g;
  }
  function u(o) {
...
function nz() {
  ...
  function r(i, u, o) {
    ...
    t.forEach(o, function(f) {
      for (var g = i.parent(f), h, y; g; ) {
        if (h = i.parent(g), h ? (y = s[h], s[h] = g) : (y = c, c = g), y && y !== g) {
          u.setEdge(y, g);
          return;
        }
        g = h;
...
function rz() {
  ...
  function g(m) {
    ...
    for (var E = Number.POSITIVE_INFINITY, M, S = 0, T = 0; T < 4; ++S, ++T) {
      y(S % 2 ? _ : A, S % 4 >= 2), w = f.buildLayerMatrix(m);
      var O = i(m, w);
...
function az() {
  ...
  function u(E, M) {
    ...
    function T(O, C) {
      ...
      return t.forEach(C, function(Y, J) {
        var K = s(E, Y), D = K ? E.node(K).order : B;
        (K || Y === X) && (t.forEach(C.slice(H, J + 1), function(G) {
  ...
  function o(E, M) {
    ...
    function T(C, R, H, B, X) {
      var Y;
      t.forEach(t.range(R, H), function(J) {
        Y = C[J], E.node(Y).dummy && t.forEach(E.predecessors(Y), function(K) {
          var D = E.node(K);
    ...
    function O(C, R) {
      var H = -1, B, X = 0;
      return t.forEach(R, function(Y, J) {
        if (E.node(Y).dummy === "border") {
          var K = E.predecessors(Y);
          K.length && (B = E.node(K[0]).order, T(R, X, J, H, B), X = J, H = B);
        }
    ...
    return t.forEach(M, function(H) {
      ...
      t.forEach(H, function(X) {
        ...
        if (Y.length) {
          ...
          for (var J = (Y.length - 1) / 2, K = Math.floor(J), D = Math.ceil(J); K <= D; ++K) {
            var G = Y[K];
  ...
  function h(E, M, S, T, O) {
    var C = {}, R = y(E, M, S, O), H = O ? "borderLeft" : "borderRight";
    function B(J, K) {
      for (var D = R.nodes(), G = D.pop(), N = {}; G; )
        N[G] ? J(G) : (N[G] = !0, D.push(G), D = D.concat(K(G))), G = D.pop();
    }
    function X(J) {
      C[J] = R.inEdges(J).reduce(function(K, D) {
        return Math.max(K, C[D.v] + R.edge(D));
      }, 0);
    }
    function Y(J) {
      var K = R.outEdges(J).reduce(function(G, N) {
        return Math.min(G, C[N.w] - R.edge(N));
      }, Number.POSITIVE_INFINITY), D = E.node(J);
      K !== Number.POSITIVE_INFINITY && D.borderType !== H && (C[J] = Math.max(C[J], K));
    }
    return B(X, R.predecessors.bind(R)), B(Y, R.successors.bind(R)), t.forEach(T, function(J) {
      C[J] = C[S[J]];
    }), C;
  }
  function y(E, M, S, T) {
    ...
    return t.forEach(M, function(H) {
      ...
      t.forEach(H, function(X) {
        var Y = S[X];
        if (O.setNode(Y), B) {
          var J = S[B], K = O.edge(J, Y);
          O.setEdge(J, Y, Math.max(R(E, X, B), K || 0));
        }
        B = X;
      });
    }), O;
  ...
  function m(E, M) {
    ...
    t.forEach(["u", "d"], function(C) {
      t.forEach(["l", "r"], function(R) {
        ...
        if (B !== M) {
          var Y = t.values(B);
          X = R === "l" ? T - t.min(Y) : O - t.max(Y), X && (E[H] = t.mapValues(B, function(J) {
            return J + X;
          }));
        }
      });
  ...
  function _(E) {
    ...
    t.forEach(["u", "d"], function(R) {
      O = R === "u" ? M : t.values(M).reverse(), t.forEach(["l", "r"], function(H) {
        H === "r" && (O = t.map(O, function(J) {
          return t.values(J).reverse();
        }));
        ...
        H === "r" && (Y = t.mapValues(Y, function(J) {
          return -J;
        })), T[R + H] = Y;
      });
    });
...
function iz() {
  ...
  function o(s) {
    ...
    t.forEach(c, function(h) {
      var y = t.max(t.map(h, function(p) {
...
function uz() {
  if (E2) return ep;
  E2 = 1;
  var t = $e(), r = VO(), i = YO(), u = XO(), o = Ut().normalizeRanks, s = IO(), c = Ut().removeEmptyRanks, f = QO(), g = ZO(), h = KO(), y = rz(), p = iz(), m = Ut(), b = gn().Graph;
  ep = _;
  function _(L, I) {
...
function lz() {
  ...
  function u(o) {
    ...
    return t.forEach(o.nodes(), function(f) {
      ...
      var h = "layer" + g;
      c.setNode(h, { rank: "same" }), t.reduce(f, function(y, p) {
        return c.setEdge(y, p, { style: "invis" }), p;
      });
    }), c;
  }
  return tp;
...
function pz(t) {
  ...
  for (var r = this._groups, i = r.length, u = new Array(i), o = 0; o < i; ++o)
    for (var s = r[o], c = s.length, f = u[o] = new Array(c), g, h, y = 0; y < c; ++y)
      (g = s[y]) && (h = t.call(g, g.__data__, y, s)) && ("__data__" in g && (h.__data__ = g.__data__), f[y] = h);
...
function Dz(t, r, i, u, o, s, c) {
  var f, g, h = /* @__PURE__ */ new Map(), y = r.length, p = s.length, m = new Array(y), b;
  for (f = 0; f < y; ++f)
...
function Lz(t, r) {
  ...
  for (var s = o.length, c = new Array(s), f = new Array(s), g = new Array(s), h = 0; h < s; ++h) {
    var y = u[h], p = o[h], m = p.length, b = Bz(t.call(y, y && y.__data__, h, u)), _ = b.length, A = f[h] = new Array(_), w = c[h] = new Array(_), E = g[h] = new Array(m);
    i(y, p, A, w, E, b, r);
...
function Gz(t) {
  for (var r = t.selection ? t.selection() : t, i = this._groups, u = r._groups, o = i.length, s = u.length, c = Math.min(o, s), f = new Array(o), g = 0; g < c; ++g)
    for (var h = i[g], y = u[g], p = h.length, m = f[g] = new Array(p), b, _ = 0; _ < p; ++_)
      (b = h[_] || y[_]) && (m[_] = b);
  for (; g < o; ++g)
    f[g] = i[g];
...
function Yz(t) {
  ...
  for (var i = this._groups, u = i.length, o = new Array(u), s = 0; s < u; ++s) {
    for (var c = i[s], f = c.length, g = o[s] = new Array(f), h, y = 0; y < f; ++y)
      (h = c[y]) && (g[y] = h);
    g.sort(r);
  }
...
function G4(t, r, i) {
  ...
  if (arguments.length < 2) {
    ...
    if (f) {
      for (var g = 0, h = f.length, y; g < h; ++g)
        for (o = 0, y = f[g]; o < s; ++o)
          if ((c = u[o]).type === y.type && c.name === y.name)
            return y.value;
    }
    return;
  }
...
function WT() {
  var t = K4, r = $4, i = F4, u = J4, o = {}, s = os("start", "drag", "end"), c = 0, f, g, h, y, p = 0;
  function m(T) {
  ...
  function S(T, O, C, R, H, B) {
    ...
    if ((D = i.call(T, new mp("beforestart", {
      ...
      return J = D.x - Y[0] || 0, K = D.y - Y[1] || 0, function G(N, j, Z) {
        var Q = Y, le;
        switch (N) {
          case "start":
            o[H] = G, le = c++;
...
const Bo = (function t(r) {
  ...
  function u(o, s) {
    ...
    return function(y) {
      return o.r = c(y), o.g = f(y), o.b = g(y), o.opacity = h(y), o + "";
    };
  }
  return u.gamma = t, u;
})(1);
...
function rM(t, r) {
  ...
  return i < r.length && (s = r.slice(i), f[c] ? f[c] += s : f[++c] = s), f.length < 2 ? g[0] ? bD(g[0].x) : mD(r) : (r = g.length, function(h) {
    for (var y = 0, p; y < r; ++y) f[(p = g[y]).i] = p.x(h);
    return f.join("");
  });
}
function Tu(t, r) {
...
function iM(t, r, i, u) {
  ...
  function s(h, y, p, m, b, _) {
    if (h !== p || y !== m) {
      var A = b.push("translate(", null, r, null, i);
      _.push({ i: A - 4, x: wn(h, p) }, { i: A - 2, x: wn(y, m) });
    } else (p || m) && b.push("translate(" + p + r + m + i);
  }
  function c(h, y, p, m) {
    h !== y ? (h - y > 180 ? y += 360 : y - h > 180 && (h += 360), m.push({ i: p.push(o(p) + "rotate(", null, u) - 2, x: wn(h, y) })) : y && p.push(o(p) + "rotate(" + y + u);
  }
  function f(h, y, p, m) {
    h !== y ? m.push({ i: p.push(o(p) + "skewX(", null, u) - 2, x: wn(h, y) }) : y && p.push(o(p) + "skewX(" + y + u);
  }
  function g(h, y, p, m, b, _) {
    if (h !== p || y !== m) {
  ...
  return function(h, y) {
    var p = [], m = [];
    return h = t(h), y = t(y), s(h.translateX, h.translateY, y.translateX, y.translateY, p, m), c(h.rotate, y.rotate, p, m), f(h.skewX, y.skewX, p, m), g(h.scaleX, h.scaleY, y.scaleX, y.scaleY, p, m), h = y = null, function(b) {
...
const Co = (function t(r, i, u) {
  function o(s, c) {
    var f = s[0], g = s[1], h = s[2], y = c[0], p = c[1], m = c[2], b = y - f, _ = p - g, A = b * b + _ * _, w, E;
    if (A < wD)
...
function zD(t, r, i) {
  ...
  function c(h) {
    ...
    for (y in u)
      if (b = u[y], b.name === i.name) {
        if (b.state === Ro) return V2(c);
        b.state === k2 ? (b.state = No, b.timer.stop(), b.on.call("interrupt", t, t.__data__, b.index, b.group), delete u[y]) : +y < r && (b.state = No, b.timer.stop(), b.on.call("cancel", t, t.__data__, b.index, b.group), delete u[y]);
      }
    if (V2(function() {
      ...
      for (i.state = Ro, o = new Array(m = i.tween.length), y = 0, p = -1; y < m; ++y)
        (b = i.tween[y].value.call(t, t.__data__, i.index, i.group)) && (o[++p] = b);
      o.length = p + 1;
    }
  }
  function f(h) {
    for (var y = h < i.duration ? i.ease.call(null, h / i.duration) : (i.timer.restart(g), i.state = wp, 1), p = -1, m = o.length; ++p < m; )
      o[p].call(t, y);
...
function l5(t) {
  ...
  for (var r = this._groups, i = t._groups, u = r.length, o = i.length, s = Math.min(u, o), c = new Array(u), f = 0; f < s; ++f)
    for (var g = r[f], h = i[f], y = g.length, p = c[f] = new Array(y), m, b = 0; b < y; ++b)
      (m = g[b] || h[b]) && (p[b] = m);
  for (; f < u; ++f)
    c[f] = r[f];
...
function h5(t) {
  ...
  for (var u = this._groups, o = u.length, s = new Array(o), c = 0; c < o; ++c)
    for (var f = u[c], g = f.length, h = s[c] = new Array(g), y, p, m = 0; m < g; ++m)
      (y = f[m]) && (p = t.call(y, y.__data__, m, f)) && ("__data__" in y && (p.__data__ = y.__data__), h[m] = p, fs(h[m], r, i, m, h, pn(y, i)));
...
function g5(t) {
  ...
  for (var u = this._groups, o = u.length, s = [], c = [], f = 0; f < o; ++f)
    for (var g = u[f], h = g.length, y, p = 0; p < h; ++p)
      if (y = g[p]) {
        for (var m = t.call(y, y.__data__, p, g), b, _ = pn(y, i), A = 0, w = m.length; A < w; ++A)
...
function _5(t, r) {
  ...
  return function() {
    var g = Mn(this, t), h = g.on, y = g.value[s] == null ? f || (f = fM(r)) : void 0;
    (h !== i || o !== y) && (u = (i = h).copy()).on(c, o = y), g.on = u;
  };
}
function x5(t, r, i) {
...
function O5() {
  ...
  return new Promise(function(s, c) {
    ...
    i.each(function() {
      var h = Mn(this, u), y = h.on;
      y !== t && (r = (t = y).copy(), r._.cancel.push(f), r._.interrupt.push(f), r._.end.push(g)), h.on = r;
    }), o === 0 && s();
  });
}
var z5 = 0;
...
function gM() {
  var t = U5, r = G5, i = k5, u = V5, o = Y5, s = [0, 1 / 0], c = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], f = 250, g = Co, h = os("start", "zoom", "end"), y, p, m, b = 500, _ = 150, A = 0, w = 10;
  function E(D) {
    D.property("__zoom", X2).on("wheel.zoom", H, { passive: !1 }).on("mousedown.zoom", B).on("dblclick.zoom", X).filter(o).on("touchstart.zoom", Y).on("touchmove.zoom", J).on("touchend.zoom touchcancel.zoom", K).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  ...
  function Y(D, ...G) {
    if (t.apply(this, arguments)) {
      ...
      for (lp(D), le = 0; le < j; ++le)
        z = N[le], V = cn(z, this), V = [V, this.__zoom.invert(V), z.identifier], Z.touch0 ? !Z.touch1 && Z.touch0[2] !== V[2] && (Z.touch1 = V, Z.taps = 0) : (Z.touch0 = V, Q = !0, Z.taps = 1 + !!y);
      y && (y = clearTimeout(y)), Q && (Z.taps < 2 && (p = V[0], y = setTimeout(function() {
        y = null;
      }, b)), Oo(this), Z.start());
    }
  }
...
const bM = (t) => !!t && typeof t == "object" && "id" in t && "source" in t && "target" in t, X5 = (t) => !!t && typeof t == "object" && "id" in t && "position" in t && !("source" in t) && !("target" in t), rm = (t) => !!t && typeof t == "object" && "id" in t && "internals" in t && !("source" in t) && !("target" in t), Iu = (t, r = [0, 0]) => {
  ...
  const f = (r.x - i) / o, g = (r.y - u) / o, h = r.width / o, y = r.height / o, p = [];
  for (const m of t.values()) {
    const { measured: b, selectable: _ = !0, hidden: A = !1 } = m;
    if (c && !_ || A)
      continue;
    const w = b.width ?? m.width ?? m.initialWidth ?? 0, E = b.height ?? m.height ?? m.initialHeight ?? 0, { x: M, y: S } = m.internals.positionAbsolute, T = EM(f, g, h, y, M, S, w, E), O = w * E, C = s && T > 0;
...
function _M({ nodeId: t, nextPosition: r, nodeLookup: i, nodeOrigin: u = [0, 0], nodeExtent: o, onError: s }) {
  const c = i.get(t), f = c.parentId ? i.get(c.parentId) : void 0, { x: g, y: h } = f ? f.internals.positionAbsolute : { x: 0, y: 0 }, y = c.origin ?? u;
  let p = c.extent || o;
  ...
  return (c.measured.width === void 0 || c.measured.height === void 0) && (s == null || s("015", vn.error015())), {
    position: {
      x: m.x - g + (c.measured.width ?? 0) * y[0],
      y: m.y - h + (c.measured.height ?? 0) * y[1]
    },
    positionAbsolute: m
  };
}
async function $5({ nodesToRemove: t = [], edgesToRemove: r = [], nodes: i, edges: u, onBeforeDelete: o }) {
  ...
  const f = new Set(r.map((m) => m.id)), g = u.filter((m) => m.deletable !== !1), y = Q5(c, g);
  for (const m of g)
    f.has(m.id) && !y.find((_) => _.id === m.id) && y.push(m);
  if (!o)
    return {
      edges: y,
      nodes: c
...
function J5(t, r, i, u, o, s) {
  const { x: c, y: f } = di(t, [r, i, u]), { x: g, y: h } = di({ x: t.x + t.width, y: t.y + t.height }, [r, i, u]), y = o - g, p = s - h;
  return {
    left: Math.floor(c),
    top: Math.floor(f),
    right: Math.floor(y),
...
const um = (t, r, i, u, o, s) => {
  const c = F5(s, r, i), f = (r - c.x) / t.width, g = (i - c.y) / t.height, h = Math.min(f, g), y = fi(h, u, o), p = t.x + t.width / 2, m = t.y + t.height / 2, b = r / 2 - p * y, _ = i / 2 - m * y, A = J5(t, b, _, y, r, i), w = {
...
function RM({ sourceX: t, sourceY: r, targetX: i, targetY: u, sourceControlX: o, sourceControlY: s, targetControlX: c, targetControlY: f }) {
  const g = t * 0.125 + o * 0.375 + c * 0.375 + i * 0.125, h = r * 0.125 + s * 0.375 + f * 0.375 + u * 0.125, y = Math.abs(g - t), p = Math.abs(h - r);
  return [g, h, y, p];
}
function wo(t, r) {
...
function l6({ source: t, sourcePosition: r = _e.Bottom, target: i, targetPosition: u = _e.Top, center: o, offset: s, stepPosition: c }) {
  const f = J2[r], g = J2[u], h = { x: t.x + f.x * s, y: t.y + f.y * s }, y = { x: i.x + g.x * s, y: i.y + g.y * s }, p = u6({
    source: h,
    sourcePosition: r,
    target: y
  }), m = p.x !== 0 ? "x" : "y", b = p[m];
  ...
  if (f[m] * g[m] === -1) {
    m === "x" ? (A = o.x ?? h.x + (y.x - h.x) * c, w = o.y ?? (h.y + y.y) / 2) : (A = o.x ?? (h.x + y.x) / 2, w = o.y ?? h.y + (y.y - h.y) * c);
    const H = [
      { x: A, y: h.y },
      { x: A, y: y.y }
    ], B = [
    ...
    const H = [{ x: h.x, y: y.y }], B = [{ x: y.x, y: h.y }];
    if (m === "x" ? _ = f.x === b ? B : H : _ = f.y === b ? H : B, r === u) {
      const D = Math.abs(t[m] - i[m]);
      if (D <= s) {
        const G = Math.min(s - 1, s - D);
        f[m] === b ? E[m] = (h[m] > t[m] ? -1 : 1) * G : M[m] = (y[m] > i[m] ? -1 : 1) * G;
      }
    }
    if (r !== u) {
      const D = m === "x" ? "y" : "x", G = f[m] === g[D], N = h[D] > y[D], j = h[D] < y[D];
      (f[m] === 1 && (!G && N || G && j) || f[m] !== 1 && (!G && j || G && N)) && (_ = m === "x" ? H : B);
    }
    const X = { x: h.x + E.x, y: h.y + E.y }, Y = { x: y.x + M.x, y: y.y + M.y }, J = Math.max(Math.abs(X.x - _[0].x), Math.abs(Y.x - _[0].x)), K = Math.max(Math.abs(X.y - _[0].y), Math.abs(Y.y - _[0].y));
    J >= K ? (A = (X.x + Y.x) / 2, w = _[0].y) : (A = _[0].x, w = (X.y + Y.y) / 2);
  }
  const O = { x: h.x + E.x, y: h.y + E.y }, C = { x: y.x + M.x, y: y.y + M.y };
  return [[
    t,
...
function o6(t, r, i, u) {
  ...
  if (t.x === s && s === i.x || t.y === c && c === i.y)
    return `L${s} ${c}`;
  if (t.y === c) {
    const h = t.x < i.x ? -1 : 1, y = t.y < i.y ? 1 : -1;
    return `L ${s + o * h},${c}Q ${s},${c} ${s},${c + o * y}`;
  }
  const f = t.x < i.x ? 1 : -1, g = t.y < i.y ? -1 : 1;
  return `L ${s},${c + o * g}Q ${s},${c} ${s + o * f},${c}`;
}
function Tp({ sourceX: t, sourceY: r, sourcePosition: i = _e.Bottom, targetX: u, targetY: o, targetPosition: s = _e.Top, borderRadius: c = 5, centerX: f, centerY: g, offset: h = 20, stepPosition: y = 0.5 }) {
  const [p, m, b, _, A] = l6({
    source: { x: t, y: r },
    sourcePosition: i,
    target: { x: u, y: o },
...
function s6(t) {
  ...
  const f = (s == null ? void 0 : s.position) || _e.Bottom, g = (c == null ? void 0 : c.position) || _e.Top, h = ca(r, s, f), y = ca(i, c, g);
  return {
    sourceX: h.x,
    sourceY: h.y,
    targetX: y.x,
  ...
  for (const m of t) {
    ...
    if (o.checkEquality && m === (b == null ? void 0 : b.internals.userNode))
      ...
      b = {
        ...
        ...m,
        measured: {
          width: (y = m.measured) == null ? void 0 : y.width,
...
function fm(t, r, i, u, o) {
  const { elevateNodesOnSelect: s, nodeOrigin: c, nodeExtent: f, zIndexMode: g } = sm(om, u), h = t.parentId, y = r.get(h);
  if (!y) {
  ...
  v6(t, i), o && !y.parentId && y.internals.rootParentIndex === void 0 && g === "auto" && (y.internals.rootParentIndex = ++o.i, y.internals.z = y.internals.z + o.i * f6), o && y.internals.rootParentIndex !== void 0 && (o.i = y.internals.rootParentIndex);
  const p = s && !cm(g) ? DM : 0, { x: m, y: b, z: _ } = y6(t, y, c, f, p, g), { positionAbsolute: A } = t.internals, w = m !== A.x || b !== A.y;
...
function y6(t, r, i, u, o, s) {
  const { x: c, y: f } = r.internals.positionAbsolute, g = qn(t), h = Iu(t, i), y = sa(t.extent) ? oa(h, t.extent, g) : h;
  let p = oa({ x: c + y.x, y: f + y.y }, u, g);
...
function dm(t, r, i, u = [0, 0]) {
  ...
  for (const f of t) {
    ...
    if (!g)
      continue;
    const h = ((c = s.get(f.parentId)) == null ? void 0 : c.expandedRect) ?? Du(g), y = SM(h, f.rect);
    s.set(f.parentId, { expandedRect: y, parent: g });
  }
  return s.size > 0 && s.forEach(({ expandedRect: f, parent: g }, h) => {
    var S;
    const y = g.internals.positionAbsolute, p = qn(g), m = g.origin ?? u, b = f.x < y.x ? Math.round(Math.abs(y.x - f.x)) : 0, _ = f.y < y.y ? Math.round(Math.abs(y.y - f.y)) : 0, A = Math.max(p.width, Math.round(f.width)), w = Math.max(p.height, Math.round(f.height)), E = (A - p.width) * m[0], M = (w - p.height) * m[1];
    (b > 0 || _ > 0 || E || M) && (o.push({
      id: h,
      type: "position",
      position: {
...
function p6(t, r, i, u, o, s, c) {
  ...
  const h = [], y = window.getComputedStyle(f), { m22: p } = new window.DOMMatrixReadOnly(y.transform), m = [];
...
function LM(t, r, i) {
  t.clear(), r.clear();
  for (const u of i) {
    const { source: o, target: s, sourceHandle: c = null, targetHandle: f = null } = u, g = { edgeId: u.id, source: o, target: s, sourceHandle: c, targetHandle: f }, h = `${o}-${c}--${s}-${f}`, y = `${s}-${f}--${o}-${c}`;
    nA("source", g, y, t, o, c), nA("target", g, h, t, s, f), r.set(u.id, u);
  }
}
function BM(t, r) {
  if (!t.parentId)
...
function x6({ onNodeMouseDown: t, getStoreItems: r, onDragStart: i, onDrag: u, onDragStop: o }) {
  let s = { x: null, y: null }, c = 0, f = /* @__PURE__ */ new Map(), g = !1, h = { x: 0, y: 0 }, y = null, p = !1, m = null, b = !1, _ = !1, A = null;
  function w({ noDragClassName: M, handleSelector: S, domNode: T, isSelectable: O, nodeId: C, nodeClickDistance: R = 0 }) {
    ...
    function H({ x: J, y: K }) {
      ...
      for (const [ae, W] of f) {
        if (!D.has(ae))
          continue;
        let se = { x: J - W.distance.x, y: K - W.distance.y };
        j && (se = P ? {
    ...
    async function B() {
      if (!y)
        return;
      const { transform: J, panBy: K, autoPanSpeed: D, autoPanOnNodeDrag: G } = r();
      if (!G) {
        g = !1, cancelAnimationFrame(c);
        return;
      }
      const [N, j] = im(h, y, D);
      (N !== 0 || j !== 0) && (s.x = (s.x ?? 0) - N / J[2], s.y = (s.y ?? 0) - j / J[2], await K({ x: N, y: j }) && H(s)), c = requestAnimationFrame(B);
    }
    function X(J) {
      var L;
      ...
      const ie = Mu(J.sourceEvent, { transform: N, snapGrid: j, snapToGrid: Z, containerBounds: y });
      if (s = ie, f = b6(K, G, ie, C), f.size > 0 && (i || le || !C && z)) {
        ...
        i == null || i(J.sourceEvent, f, I, P), le == null || le(J.sourceEvent, I, P), C || z == null || z(J.sourceEvent, P);
      }
    }
    const Y = WT().clickDistance(R).on("start", (J) => {
      const { domNode: K, nodeDragThreshold: D, transform: G, snapGrid: N, snapToGrid: j } = r();
      y = (K == null ? void 0 : K.getBoundingClientRect()) || null, b = !1, _ = !1, A = J.sourceEvent, D === 0 && X(J), s = Mu(J.sourceEvent, { transform: G, snapGrid: N, snapToGrid: j, containerBounds: y }), h = hn(J.sourceEvent, y);
    }).on("drag", (J) => {
      const { autoPanOnNodeDrag: K, transform: D, snapGrid: G, snapToGrid: N, nodeDragThreshold: j, nodeLookup: Z } = r(), Q = Mu(J.sourceEvent, { transform: D, snapGrid: G, snapToGrid: N, containerBounds: y });
      ...
      C && !Z.has(C)) && (b = !0), !b) {
        if (!g && K && p && (g = !0, B()), !p) {
          const le = hn(J.sourceEvent, y), z = le.x - h.x, V = le.y - h.y;
          Math.sqrt(z * z + V * V) > j && X(J);
        }
        (s.x !== Q.xSnapped || s.y !== Q.ySnapped) && f && p && (h = hn(J.sourceEvent, y), H(Q));
      }
    }).on("end", (J) => {
      if (!p || b) {
      ...
      if (g = !1, p = !1, cancelAnimationFrame(c), f.size > 0) {
        ...
        if (_ && (D(f, !1), _ = !1), o || G || !C && N) {
          ...
          o == null || o(J.sourceEvent, f, j, Z), G == null || G(J.sourceEvent, j, Z), C || N == null || N(J.sourceEvent, Z);
        }
      }
    }).filter((J) => {
      const K = J.target;
      return !J.button && (!M || !rA(K, `.${M}`, T)) && (!S || rA(K, S, T));
    });
    m.call(Y);
  }
  function E() {
...
function w6(t, r, i, u) {
  ...
  const c = S6(t, i, r + E6);
  for (const h of c) {
    const y = [...((f = h.internals.handleBounds) == null ? void 0 : f.source) ?? [], ...((g = h.internals.handleBounds) == null ? void 0 : g.target) ?? []];
    for (const p of y) {
...
function jM(t, r, i, u, o, s = !1) {
  ...
  if (!c)
    return null;
  const f = o === "strict" ? (h = c.internals.handleBounds) == null ? void 0 : h[r] : [...((y = c.internals.handleBounds) == null ? void 0 : y.source) ?? [], ...((p = c.internals.handleBounds) == null ? void 0 : p.target) ?? []], g = (i ? f == null ? void 0 : f.find((m) => m.id === i) : f == null ? void 0 : f[0]) ?? null;
...
const GM = () => !0;
function T6(t, { connectionMode: r, connectionRadius: i, handleId: u, nodeId: o, edgeUpdaterType: s, isTarget: c, domNode: f, nodeLookup: g, lib: h, autoPanOnConnect: y, flowId: p, panBy: m, cancelConnection: b, onConnectStart: _, onConnect: A, onConnectEnd: w, isValidConnection: E = GM, onReconnectEnd: M, updateConnection: S, getTransform: T, getFromHandle: O, autoPanSpeed: C, dragThreshold: R = 1, handleDomNode: H }) {
  const B = MM(t.target);
  let X = 0, Y;
  const { x: J, y: K } = hn(t), D = UM(s, H), G = f == null ? void 0 : f.getBoundingClientRect();
  let N = !1;
  if (!G || !D)
    return;
  ...
  function se(ve) {
    if (!N) {
      const { x: xe, y: Pe } = hn(ve), tt = xe - J, xt = Pe - K;
      if (!(tt * tt + xt * xt > R * R))
        return;
      W();
    }
...
function VM(t, { handle: r, connectionMode: i, fromNodeId: u, fromHandleId: o, fromType: s, doc: c, lib: f, flowId: g, isValidConnection: h = GM, nodeLookup: y }) {
  ...
  if (w) {
    ...
    E.isValid = B && h(R), E.toHandle = jM(S, M, T, y, i, !0);
  }
  return E;
}
const Cp = {
...
function M6({ domNode: t, panZoom: r, getTransform: i, getViewScale: u }) {
  const o = Zt(t);
  function s({ translateExtent: f, width: g, height: h, zoomStep: y = 1, pannable: p = !0, zoomable: m = !0, inversePan: b = !1 }) {
    const _ = (S) => {
      if (S.sourceEvent.type !== "wheel" || !r)
        return;
      const T = i(), O = S.sourceEvent.ctrlKey && Hu() ? 10 : 1, C = -S.sourceEvent.deltaY * (S.sourceEvent.deltaMode === 1 ? 0.05 : S.sourceEvent.deltaMode ? 1 : 2e-3) * y, R = T[2] * Math.pow(2, C * O);
      r.scaleTo(R);
    };
    let A = [0, 0];
    const w = (S) => {
...
function C6({ zoomPanValues: t, noWheelClassName: r, d3Selection: i, d3Zoom: u, panOnScrollMode: o, panOnScrollSpeed: s, zoomOnPinch: c, onPanZoomStart: f, onPanZoom: g, onPanZoomEnd: h }) {
  return (y) => {
    ...
    if (y.ctrlKey && c) {
      const w = cn(y), E = kM(y), M = p * Math.pow(2, E);
      u.scaleTo(i, M, w, y);
      return;
    }
    const m = y.deltaMode === 1 ? 20 : 1;
    let b = o === ia.Vertical ? 0 : y.deltaX * m, _ = o === ia.Horizontal ? 0 : y.deltaY * m;
    !Hu() && y.shiftKey && o !== ia.Vertical && (b = y.deltaY * m, _ = 0), u.translateBy(
      i,
      -(b / p) * s,
      -(_ / p) * s,
      // @ts-ignore
    ...
    clearTimeout(t.panScrollTimeout), t.isPanScrolling ? g == null || g(y, A) : (t.isPanScrolling = !0, f == null || f(y, A)), t.panScrollTimeout = setTimeout(() => {
      h == null || h(y, A), t.isPanScrolling = !1;
    }, 150);
  };
}
...
function D6({ zoomActivationKeyPressed: t, zoomOnScroll: r, zoomOnPinch: i, panOnDrag: u, panOnScroll: o, zoomOnDoubleClick: s, userSelectionActive: c, noWheelClassName: f, noPanClassName: g, lib: h, connectionInProgress: y }) {
  return (p) => {
    var w;
    const m = t || r, b = i && p.ctrlKey, _ = p.type === "wheel";
    if (p.button === 1 && p.type === "mousedown" && (ai(p, `${h}-flow__node`) || ai(p, `${h}-flow__edge`)))
      return !0;
    if (!u && !m && !o && !s && !i || c || y && !_ || ai(p, f) && _ || ai(p, g) && (!_ || o && _ && !t) || !i && p.ctrlKey && _)
      return !1;
...
function B6(t, r, i, u, o, s, c, f) {
  ...
  const { isHorizontal: y, isVertical: p } = r, m = y && p, { xSnapped: b, ySnapped: _ } = i, { minWidth: A, maxWidth: w, minHeight: E, maxHeight: M } = u, { x: S, y: T, width: O, height: C, aspectRatio: R } = t;
  let H = Math.floor(y ? b - t.pointerX : 0), B = Math.floor(p ? _ - t.pointerY : 0);
  const X = O + (g ? -H : H), Y = C + (h ? -B : B), J = -s[0] * O, K = -s[1] * C;
  let D = Ao(X, A, w), G = Ao(Y, E, M);
  if (c) {
    let Z = 0, Q = 0;
    g && H < 0 ? Z = Nr(S + H + J, c[0][0]) : !g && H > 0 && (Z = Or(S + X + J, c[1][0])), h && B < 0 ? Q = Nr(T + B + K, c[0][1]) : !h && B > 0 && (Q = Or(T + Y + K, c[1][1])), D = Math.max(D, Z), G = Math.max(G, Q);
  }
  if (f) {
    let Z = 0, Q = 0;
  ...
  if (o) {
    ...
    if (p) {
      ...
      if (G = Math.max(G, Z), c) {
        let Q = 0;
        !g && !h || h && !g && m ? Q = Or(S + Y * R + J, c[1][0]) / R : Q = Nr(S + (h ? B : -B) * R + J, c[0][0]) / R, G = Math.max(G, Q);
      }
      if (f) {
        let Q = 0;
  ...
  B = B + (B < 0 ? G : -G), H = H + (H < 0 ? D : -D), o && (m ? X > Y * R ? B = (iA(g, h) ? -H : H) / R : H = (iA(g, h) ? -B : B) * R : y ? (B = H / R, h = g) : (H = B * R, g = h));
...
function G6({ domNode: t, nodeId: r, getStoreItems: i, onChange: u, onEnd: o }) {
  ...
  function f({ controlPosition: h, boundaries: y, keepAspectRatio: p, resizeDirection: m, onResizeStart: b, onResize: _, onResizeEnd: A, shouldResize: w }) {
    let E = { ...XM }, M = { ...j6 };
    c = {
      boundaries: y,
      resizeDirection: m,
    ...
    const X = WT().on("start", (Y) => {
      const { nodeLookup: J, transform: K, snapGrid: D, snapToGrid: G, nodeOrigin: N, paneDomNode: j } = i();
      if (S = J.get(r), !S)
        return;
      ...
      }, C = void 0, R = sa(S.extent) ? S.extent : void 0, S.parentId && (S.extent === "parent" || S.expandParent) && (C = J.get(S.parentId)), C && S.extent === "parent" && (R = [
        [0, 0],
      ...
      const { transform: J, snapGrid: K, snapToGrid: D, nodeOrigin: G } = i(), N = Mu(Y.sourceEvent, {
        transform: J,
        snapGrid: K,
        snapToGrid: D,
        containerBounds: T
...
function V6() {
  ...
  var y = typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u" ? h : f;
  return gp.useSyncExternalStore = t.useSyncExternalStore !== void 0 ? t.useSyncExternalStore : y, gp;
}
var lA;
function Y6() {
...
function k6() {
  ...
  return dp.useSyncExternalStoreWithSelector = function(h, y, p, m, b) {
    var _ = s(null);
    if (_.current === null) {
...
const Q6 = /* @__PURE__ */ Np(I6), Z6 = {}, cA = (t) => {
  let r;
  const i = /* @__PURE__ */ new Set(), u = (y, p) => {
    const m = typeof y == "function" ? y(r) : y;
    if (!Object.is(m, r)) {
      const b = r;
      r = p ?? (typeof m != "object" || m === null) ? m : Object.assign({}, r, m), i.forEach((_) => _(r, b));
    }
  }, o = () => r, g = { setState: u, getState: o, getInitialState: () => h, subscribe: (y) => (i.add(y), () => i.delete(y)), destroy: () => {
...
function a8({ rfId: t }) {
  const r = ze(n8);
  return F.jsx("div", { id: `${t8}-${t}`, "aria-live": "assertive", "aria-atomic": "true", style: e8, children: r });
}
function i8({ rfId: t, disableKeyboardA11y: r }) {
  const i = ze(r8);
  return F.jsxs(F.Fragment, { children: [F.jsx("div", { id: `${ZM}-${t}`, style: dA, children: r ? i["node.a11yDescription.default"] : i["node.a11yDescription.keyboardDisabled"] }), F.jsx("div", { id: `${KM}-${t}`, style: dA, children: i["edge.a11yDescription.default"] }), !r && F.jsx(a8, { rfId: t })] });
}
const ps = re.forwardRef(({ position: t = "top-left", children: r, className: i, style: u, ...o }, s) => {
  const c = `${t}`.split("-");
  return F.jsx("div", { className: ct(["react-flow__panel", i, ...c]), style: u, ref: s, ...o, children: r });
});
ps.displayName = "Panel";
const hA = "https://reactflow.dev?utm_source=attribution";
function u8({ proOptions: t, position: r = "bottom-right" }) {
  return t != null && t.hideAttribution ? null : F.jsx(ps, { position: r, className: "react-flow__attribution", "data-message": `Please only hide this attribution when you are subscribed to React Flow Pro: ${hA}`, children: F.jsx("a", { href: hA, target: "_blank", rel: "noopener noreferrer", "aria-label": "React Flow attribution", children: "React Flow" }) });
}
const l8 = (t) => {
  const r = [], i = [];
...
function f8({ onSelectionChange: t }) {
  const r = ze(c8);
  return t || r ? F.jsx(s8, { onSelectionChange: t }) : null;
}
...
function v8(t) {
  ...
  const y = re.useRef(vA);
  return re.useEffect(
    () => {
      for (const p of gA) {
        const m = t[p], b = y.current[p];
...
`)), y = h.reduce((p, m) => p.concat(...m), []);
  ...
  return re.useEffect(() => {
    ...
    if (t !== null) {
      ...
      return g == null || g.addEventListener("keydown", y), g == null || g.addEventListener("keyup", p), window.addEventListener("blur", m), window.addEventListener("contextmenu", m), () => {
        g == null || g.removeEventListener("keydown", y), g == null || g.removeEventListener("keyup", p), window.removeEventListener("blur", m), window.removeEventListener("contextmenu", m);
      };
    }
  }, [t, u]), i;
}
  ...
  return re.useMemo(() => ({
    ...
    screenToFlowPosition: (r, i = {}) => {
      ...
      const { x: f, y: g } = c.getBoundingClientRect(), h = {
        x: r.x - f,
        y: r.y - g
      }, y = i.snapGrid ?? o, p = i.snapToGrid ?? s;
      return Ku(h, u, p, y);
    },
...
function A8({ children: t }) {
  const r = Qe(), i = re.useCallback((f) => {
    const { nodes: g = [], setNodes: h, hasDefaultNodes: y, onNodesChange: p, nodeLookup: m, fitViewQueued: b, onNodesChangeMiddlewareMap: _ } = r.getState();
    let A = g;
    for (const E of f)
    ...
    for (const E of _.values())
      w = E(w);
    y && h(A), w.length > 0 ? p == null || p(w) : b && window.requestAnimationFrame(() => {
      const { fitViewQueued: E, nodes: M, setNodes: S } = r.getState();
      E && S(M);
    });
  }, []), u = EA(i), o = re.useCallback((f) => {
    const { edges: g = [], setEdges: h, hasDefaultEdges: y, onEdgesChange: p, edgeLookup: m } = r.getState();
    let b = g;
    for (const _ of f)
  ...
  return F.jsx(WM.Provider, { value: c, children: t });
}
function T8() {
...
function O8({ onPaneContextMenu: t, zoomOnScroll: r = !0, zoomOnPinch: i = !0, panOnScroll: u = !1, panOnScrollSpeed: o = 0.5, panOnScrollMode: s = ia.Free, zoomOnDoubleClick: c = !0, panOnDrag: f = !0, defaultViewport: g, translateExtent: h, minZoom: y, maxZoom: p, zoomActivationKeyCode: m, preventScrolling: b = !0, children: _, noWheelClassName: A, noPanClassName: w, onViewportChange: E, isControlledViewport: M, paneClickDistance: S, selectionOnDrag: T }) {
  const O = Qe(), C = re.useRef(null), { userSelectionActive: R, lib: H, connectionInProgress: B } = ze(N8, Je), X = Lu(m), Y = re.useRef();
  R8(C);
  const J = re.useCallback((K) => {
  ...
  return re.useEffect(() => {
    ...
    T,
    S
  ]), F.jsx("div", { className: "react-flow__renderer", ref: C, style: ms, children: _ });
}
const z8 = (t) => ({
  userSelectionActive: t.userSelectionActive,
...
function D8() {
  ...
  return t && r ? F.jsx("div", { className: "react-flow__selection react-flow__container", style: {
    width: r.width,
    height: r.height,
...
function L8({ isSelecting: t, selectionKeyPressed: r, selectionMode: i = zu.Full, panOnDrag: u, autoPanOnSelection: o, paneClickDistance: s, selectionOnDrag: c, onSelectionStart: f, onSelectionEnd: g, onPaneClick: h, onPaneContextMenu: y, onPaneScroll: p, onPaneMouseEnter: m, onPaneMouseMove: b, onPaneMouseLeave: _, children: A }) {
  const w = re.useRef(0), E = Qe(), { userSelectionActive: M, elementsSelectable: S, dragging: T, panBy: O, autoPanSpeed: C } = ze(H8, Je), R = S && (t || M), H = re.useRef(null), B = re.useRef(), X = re.useRef(/* @__PURE__ */ new Set()), Y = re.useRef(/* @__PURE__ */ new Set()), J = re.useRef(!1), K = re.useRef(!1), D = re.useRef({ x: 0, y: 0 }), G = re.useRef(!1), N = (W) => {
    if (K.current || J.current || E.getState().connection.inProgress) {
      K.current = !1, J.current = !1;
      return;
    }
  ...
  const L = (W) => {
    ...
    var se, de;
    if (!R) {
      W.target === H.current && E.getState().connection.inProgress && (J.current = !0);
      return;
    }
  ...
  return re.useEffect(() => {
    if (!r)
      return y.current = x6({
        ...
        var p;
        (p = y.current) == null || p.destroy(), y.current = void 0;
      };
  }, [r, f, t]), re.useEffect(() => {
    r || !t.current || !y.current || y.current.update({
      noDragClassName: i,
      handleSelector: u,
      domNode: t.current,
      isSelectable: s,
...
function tq() {
  ...
  return re.useCallback((i) => {
    const { nodeExtent: u, snapToGrid: o, snapGrid: s, nodesDraggable: c, onError: f, updateNodePositions: g, nodeLookup: h, nodeOrigin: y } = t.getState(), p = /* @__PURE__ */ new Map(), m = B8(c), b = o ? s[0] : 5, _ = o ? s[1] : 5, A = i.direction.x * b * i.factor, w = i.direction.y * _ * i.factor;
    for (const [, E] of h) {
      if (!m(E))
        continue;
      let M = {
...
function G8({ children: t }) {
  const r = ze(U8, Je);
  return F.jsx(rq.Provider, { value: r, children: t });
}
function V8() {
...
const Y8 = {
  ...
  if (!f && !o)
    return Y8;
  const y = (g == null ? void 0 : g.nodeId) === t && (g == null ? void 0 : g.id) === r && (g == null ? void 0 : g.type) === i;
  return {
...
function X8({ type: t = "source", position: r = _e.Top, isValidConnection: i, isConnectable: u = !0, isConnectableStart: o = !0, isConnectableEnd: s = !0, id: c, onConnect: f, children: g, className: h, onMouseDown: y, onTouchStart: p, ...m }, b) {
  var G, N;
  ...
  return F.jsx("div", { "data-handleid": _, "data-nodeid": E, "data-handlepos": r, "data-id": `${T}-${E}-${_}-${t}`, className: ct([
    "react-flow__handle",
...
function I8({ data: t, isConnectable: r, sourcePosition: i = _e.Bottom }) {
  return F.jsxs(F.Fragment, { children: [t == null ? void 0 : t.label, F.jsx(gi, { type: "source", position: i, isConnectable: r })] });
}
function Q8({ data: t, isConnectable: r, targetPosition: i = _e.Top, sourcePosition: u = _e.Bottom }) {
  return F.jsxs(F.Fragment, { children: [F.jsx(gi, { type: "target", position: i, isConnectable: r }), t == null ? void 0 : t.label, F.jsx(gi, { type: "source", position: u, isConnectable: r })] });
}
function Z8() {
  return null;
}
function K8({ data: t, isConnectable: r, targetPosition: i = _e.Top }) {
  return F.jsxs(F.Fragment, { children: [F.jsx(gi, { type: "target", position: i, isConnectable: r }), t == null ? void 0 : t.label] });
}
const Xo = {
  ArrowUp: { x: 0, y: -1 },
  ArrowDown: { x: 0, y: 1 },
...
function J8({ onSelectionContextMenu: t, noPanClassName: r, disableKeyboardA11y: i }) {
  ...
  return F.jsx("div", { className: ct(["react-flow__nodesselection", "react-flow__container", r]), style: {
    transform: c
  }, children: F.jsx("div", { ref: h, className: "react-flow__nodesselection-rect", onContextMenu: p, tabIndex: i ? void 0 : -1, onKeyDown: i ? void 0 : m, style: {
    width: o,
    height: s
  } }) });
}
...
function aq({ children: t, onPaneClick: r, onPaneMouseEnter: i, onPaneMouseMove: u, onPaneMouseLeave: o, onPaneContextMenu: s, onPaneScroll: c, paneClickDistance: f, deleteKeyCode: g, selectionKeyCode: h, selectionOnDrag: y, selectionMode: p, onSelectionStart: m, onSelectionEnd: b, multiSelectionKeyCode: _, panActivationKeyCode: A, zoomActivationKeyCode: w, elementsSelectable: E, zoomOnScroll: M, zoomOnPinch: S, panOnScroll: T, panOnScrollSpeed: O, panOnScrollMode: C, zoomOnDoubleClick: R, panOnDrag: H, autoPanOnSelection: B, defaultViewport: X, translateExtent: Y, minZoom: J, maxZoom: K, preventScrolling: D, onSelectionContextMenu: G, noWheelClassName: N, noPanClassName: j, disableKeyboardA11y: Z, onViewportChange: Q, isControlledViewport: le }) {
  const { nodesSelectionActive: z, userSelectionActive: V } = ze(P8, Je), ie = Lu(h, { target: TA }), L = Lu(A, { target: TA }), I = L || H, P = L || T, ae = y && I !== !0, W = ie || V || ae;
  return C8({ deleteKeyCode: g, multiSelectionKeyCode: _ }), F.jsx(O8, { onPaneContextMenu: s, elementsSelectable: E, zoomOnScroll: M, zoomOnPinch: S, panOnScroll: P, panOnScrollSpeed: O, panOnScrollMode: C, zoomOnDoubleClick: R, panOnDrag: !ie && I, defaultViewport: X, translateExtent: Y, minZoom: J, maxZoom: K, zoomActivationKeyCode: w, preventScrolling: D, noWheelClassName: N, noPanClassName: j, onViewportChange: Q, isControlledViewport: le, paneClickDistance: f, selectionOnDrag: ae, children: F.jsxs(L8, { onSelectionStart: m, onSelectionEnd: b, onPaneClick: r, onPaneMouseEnter: i, onPaneMouseMove: u, onPaneMouseLeave: o, onPaneContextMenu: s, onPaneScroll: c, panOnDrag: I, autoPanOnSelection: B, isSelecting: !!W, selectionMode: p, selectionKeyPressed: ie, paneClickDistance: f, selectionOnDrag: ae, children: [t, z && F.jsx(J8, { onSelectionContextMenu: G, noPanClassName: j, disableKeyboardA11y: Z })] }) });
}
...
function aH({ node: t, nodeType: r, hasDimensions: i, resizeObserver: u }) {
  const o = Qe(), s = re.useRef(null), c = re.useRef(null), f = re.useRef(t.sourcePosition), g = re.useRef(t.targetPosition), h = re.useRef(r), y = i && !!t.internals.handleBounds;
  return re.useEffect(() => {
    s.current && !t.hidden && (!y || c.current !== s.current) && (c.current && (u == null || u.unobserve(c.current)), u == null || u.observe(s.current), c.current = s.current);
  }, [y, t.hidden]), re.useEffect(() => () => {
...
function iH({ id: t, onClick: r, onMouseEnter: i, onMouseMove: u, onMouseLeave: o, onContextMenu: s, onDoubleClick: c, nodesDraggable: f, elementsSelectable: g, nodesConnectable: h, nodesFocusable: y, resizeObserver: p, noDragClassName: m, noPanClassName: b, disableKeyboardA11y: _, rfId: A, nodeTypes: w, nodeClickDistance: E, onError: M }) {
  ...
  const H = !!(S.draggable || f && typeof S.draggable > "u"), B = !!(S.selectable || g && typeof S.selectable > "u"), X = !!(S.connectable || h && typeof S.connectable > "u"), Y = !!(S.focusable || y && typeof S.focusable > "u"), J = Qe(), K = AM(S), D = aH({ node: S, nodeType: C, hasDimensions: K, resizeObserver: p }), G = eq({
    nodeRef: D,
    disabled: S.hidden || !H,
    noDragClassName: m,
  ...
  const j = qn(S), Z = $8(S), Q = B || H || r || i || u || o, le = i ? (W) => i(W, { ...T.userNode }) : void 0, z = u ? (W) => u(W, { ...T.userNode }) : void 0, V = o ? (W) => o(W, { ...T.userNode }) : void 0, ie = s ? (W) => s(W, { ...T.userNode }) : void 0, L = c ? (W) => c(W, { ...T.userNode }) : void 0, I = (W) => {
    const { selectNodesOnDrag: se, nodeDragThreshold: de } = J.getState();
    B && (!se || !H || de > 0) && Rp({
      id: t,
      store: J,
      nodeRef: D
    ...
    if (!(qM(W.nativeEvent) || _)) {
      if (vM.includes(W.key) && B) {
        ...
        W.preventDefault();
        const { ariaLabelConfig: se } = J.getState();
        J.setState({
    ...
    if (_ || !((me = D.current) != null && me.matches(":focus-visible")))
      return;
    const { transform: W, width: se, height: de, autoPanOnNodeFocus: ve, setCenter: pe } = J.getState();
    if (!ve)
      return;
...
function iq(t) {
  ...
  return F.jsx("div", { className: "react-flow__nodes", style: ms, children: s.map((f) => (
    /*
     ...
     */
    F.jsx(uH, { id: f, nodeTypes: t.nodeTypes, nodeExtent: t.nodeExtent, onClick: t.onNodeClick, onMouseEnter: t.onNodeMouseEnter, onMouseMove: t.onNodeMouseMove, onMouseLeave: t.onNodeMouseLeave, onContextMenu: t.onNodeContextMenu, onDoubleClick: t.onNodeDoubleClick, noDragClassName: t.noDragClassName, noPanClassName: t.noPanClassName, rfId: t.rfId, disableKeyboardA11y: t.disableKeyboardA11y, resizeObserver: c, nodesDraggable: t.nodesDraggable ?? !0, nodesConnectable: r, nodesFocusable: i, elementsSelectable: u, nodeClickDistance: t.nodeClickDistance, onError: o }, f)
  )) });
}
...
const cH = ({ color: t = "none", strokeWidth: r = 1 }) => {
  ...
  return F.jsx("polyline", { className: "arrow", style: i, strokeLinecap: "round", fill: "none", strokeLinejoin: "round", points: "-5,-4 0,0 -5,4" });
}, fH = ({ color: t = "none", strokeWidth: r = 1 }) => {
  const i = {
    strokeWidth: r,
    ...t && { stroke: t, fill: t }
  };
  return F.jsx("polyline", { className: "arrowclosed", style: i, strokeLinecap: "round", strokeLinejoin: "round", points: "-5,-4 0,0 -5,4 -5,-4" });
}, MA = {
  [Vo.Arrow]: cH,
  [Vo.ArrowClosed]: fH
};
...
const hH = ({ id: t, type: r, color: i, width: u = 12.5, height: o = 12.5, markerUnits: s = "strokeWidth", strokeWidth: c, orient: f = "auto-start-reverse" }) => {
  const g = dH(r);
  return g ? F.jsx("marker", { className: "react-flow__arrowhead", id: t, markerWidth: `${u}`, markerHeight: `${o}`, viewBox: "-10 -10 20 20", markerUnits: s, orient: f, refX: "0", refY: "0", children: F.jsx(g, { color: i, strokeWidth: c }) }) : null;
  ...
  return o.length ? F.jsx("svg", { className: "react-flow__marker", "aria-hidden": "true", children: F.jsx("defs", { children: o.map((s) => F.jsx(hH, { id: s.id, type: s.type, color: s.color, width: s.width, height: s.height, markerUnits: s.markerUnits, strokeWidth: s.strokeWidth, orient: s.orient }, s.id)) }) }) : null;
};
uq.displayName = "MarkerDefinitions";
var gH = re.memo(uq);
function lq({ x: t, y: r, label: i, labelStyle: u, labelShowBg: o = !0, labelBgStyle: s, labelBgPadding: c = [2, 4], labelBgBorderRadius: f = 2, children: g, className: h, ...y }) {
  ...
  }, [i]), i ? F.jsxs("g", { transform: `translate(${t - p.width / 2} ${r - p.height / 2})`, className: b, visibility: p.width ? "visible" : "hidden", ...y, children: [o && F.jsx("rect", { width: p.width + 2 * c[0], x: -c[0], y: -c[1], height: p.height + 2 * c[1], className: "react-flow__edge-textbg", style: s, rx: f, ry: f }), F.jsx("text", { className: "react-flow__edge-text", y: p.height / 2, dy: "0.3em", ref: _, style: u, children: i }), g] }) : null;
}
lq.displayName = "EdgeText";
const vH = re.memo(lq);
function bs({ path: t, labelX: r, labelY: i, label: u, labelStyle: o, labelShowBg: s, labelBgStyle: c, labelBgPadding: f, labelBgBorderRadius: g, interactionWidth: h = 20, ...y }) {
  return F.jsxs(F.Fragment, { children: [F.jsx("path", { ...y, d: t, fill: "none", className: ct(["react-flow__edge-path", y.className]) }), h ? F.jsx("path", { d: t, fill: "none", strokeOpacity: 0, strokeWidth: h, className: "react-flow__edge-interaction" }) : null, u && dn(r) && dn(i) ? F.jsx(vH, { x: r, y: i, label: u, labelStyle: o, labelShowBg: s, labelBgStyle: c, labelBgPadding: f, labelBgBorderRadius: g }) : null] });
}
...
function sq(t) {
  return re.memo(({ id: r, sourceX: i, sourceY: u, targetX: o, targetY: s, sourcePosition: c, targetPosition: f, label: g, labelStyle: h, labelShowBg: y, labelBgStyle: p, labelBgPadding: m, labelBgBorderRadius: b, style: _, markerEnd: A, markerStart: w, interactionWidth: E }) => {
    const [M, S, T] = oq({
      sourceX: i,
      sourceY: u,
      sourcePosition: c,
    ...
    return F.jsx(bs, { id: O, path: M, labelX: S, labelY: T, label: g, labelStyle: h, labelShowBg: y, labelBgStyle: p, labelBgPadding: m, labelBgBorderRadius: b, style: _, markerEnd: A, markerStart: w, interactionWidth: E });
  });
}
...
function fq(t) {
  return re.memo(({ id: r, sourceX: i, sourceY: u, targetX: o, targetY: s, label: c, labelStyle: f, labelShowBg: g, labelBgStyle: h, labelBgPadding: y, labelBgBorderRadius: p, style: m, sourcePosition: b = _e.Bottom, targetPosition: _ = _e.Top, markerEnd: A, markerStart: w, pathOptions: E, interactionWidth: M }) => {
    const [S, T, O] = Tp({
      sourceX: i,
      sourceY: u,
      sourcePosition: b,
    ...
    return F.jsx(bs, { id: C, path: S, labelX: T, labelY: O, label: c, labelStyle: f, labelShowBg: g, labelBgStyle: h, labelBgPadding: y, labelBgBorderRadius: p, style: m, markerEnd: A, markerStart: w, interactionWidth: M });
  });
}
...
function gq(t) {
  return re.memo(({ id: r, ...i }) => {
    ...
    return F.jsx(dq, { ...i, id: u, pathOptions: re.useMemo(() => {
      var s;
...
function yq(t) {
  return re.memo(({ id: r, sourceX: i, sourceY: u, targetX: o, targetY: s, label: c, labelStyle: f, labelShowBg: g, labelBgStyle: h, labelBgPadding: y, labelBgBorderRadius: p, style: m, markerEnd: b, markerStart: _, interactionWidth: A }) => {
    const [w, E, M] = zM({ sourceX: i, sourceY: u, targetX: o, targetY: s }), S = t.isInternal ? void 0 : r;
    return F.jsx(bs, { id: S, path: w, labelX: E, labelY: M, label: c, labelStyle: f, labelShowBg: g, labelBgStyle: h, labelBgPadding: y, labelBgBorderRadius: p, style: m, markerEnd: b, markerStart: _, interactionWidth: A });
  });
}
...
function mq(t) {
  return re.memo(({ id: r, sourceX: i, sourceY: u, targetX: o, targetY: s, sourcePosition: c = _e.Bottom, targetPosition: f = _e.Top, label: g, labelStyle: h, labelShowBg: y, labelBgStyle: p, labelBgPadding: m, labelBgBorderRadius: b, style: _, markerEnd: A, markerStart: w, pathOptions: E, interactionWidth: M }) => {
    const [S, T, O] = NM({
      sourceX: i,
      sourceY: u,
      sourcePosition: c,
    ...
    return F.jsx(bs, { id: C, path: S, labelX: T, labelY: O, label: g, labelStyle: h, labelShowBg: y, labelBgStyle: p, labelBgPadding: m, labelBgBorderRadius: b, style: _, markerEnd: A, markerStart: w, interactionWidth: M });
  });
}
...
function OA({ position: t, centerX: r, centerY: i, radius: u = 10, onMouseDown: o, onMouseEnter: s, onMouseOut: c, type: f }) {
  return F.jsx("circle", { onMouseDown: o, onMouseEnter: s, onMouseOut: c, className: ct([NA, `${NA}-${f}`]), cx: _H(r, u, t), cy: xH(i, u, t), r: u, stroke: "transparent", fill: "transparent" });
}
function SH({ isReconnectable: t, reconnectRadius: r, edge: i, sourceX: u, sourceY: o, targetX: s, targetY: c, sourcePosition: f, targetPosition: g, onReconnect: h, onReconnectStart: y, onReconnectEnd: p, setReconnecting: m, setUpdateHover: b }) {
  const _ = Qe(), A = (T, O) => {
    if (T.button !== 0)
      return;
    const { autoPanOnConnect: C, domNode: R, connectionMode: H, connectionRadius: B, lib: X, onConnectStart: Y, cancelConnection: J, nodeLookup: K, rfId: D, panBy: G, updateConnection: N } = _.getState(), j = O.type === "target", Z = (z, V) => {
      m(!1), p == null || p(z, i, O.type, V);
    }, Q = (z) => h == null ? void 0 : h(i, z), le = (z, V) => {
      m(!0), y == null || y(T, i, O.type), Y == null || Y(z, V);
    };
  ...
  return F.jsxs(F.Fragment, { children: [(t === !0 || t === "source") && F.jsx(OA, { position: f, centerX: u, centerY: o, radius: r, onMouseDown: w, onMouseEnter: M, onMouseOut: S, type: "source" }), (t === !0 || t === "target") && F.jsx(OA, { position: g, centerX: s, centerY: c, radius: r, onMouseDown: E, onMouseEnter: M, onMouseOut: S, type: "target" })] });
}
function EH({ id: t, edgesFocusable: r, edgesReconnectable: i, elementsSelectable: u, onClick: o, onDoubleClick: s, onContextMenu: c, onMouseEnter: f, onMouseMove: g, onMouseLeave: h, reconnectRadius: y, onReconnect: p, onReconnectStart: m, onReconnectEnd: b, rfId: _, edgeTypes: A, noPanClassName: w, onError: E, disableKeyboardA11y: M }) {
  ...
  const R = !!(S.focusable || r && typeof S.focusable > "u"), H = typeof p < "u" && (S.reconnectable || i && typeof S.reconnectable > "u"), B = !!(S.selectable || u && typeof S.selectable > "u"), X = re.useRef(null), [Y, J] = re.useState(!1), [K, D] = re.useState(!1), G = Qe(), { zIndex: N = S.zIndex, sourceX: j, sourceY: Z, targetX: Q, targetY: le, sourcePosition: z, targetPosition: V } = ze(re.useCallback((pe) => {
  ...
  return F.jsx("svg", { style: { zIndex: N }, children: F.jsxs("g", { className: ct([
    "react-flow__edge",
    `react-flow__edge-${O}`,
    S.className,
    w,
...
function _q({ defaultMarkerColor: t, onlyRenderVisibleElements: r, rfId: i, edgeTypes: u, noPanClassName: o, onReconnect: s, onEdgeContextMenu: c, onEdgeMouseEnter: f, onEdgeMouseMove: g, onEdgeMouseLeave: h, onEdgeClick: y, reconnectRadius: p, onEdgeDoubleClick: m, onReconnectStart: b, onReconnectEnd: _, disableKeyboardA11y: A }) {
  const { edgesFocusable: w, edgesReconnectable: E, elementsSelectable: M, onError: S } = ze(AH, Je), T = sH(r);
  return F.jsxs("div", { className: "react-flow__edges", children: [F.jsx(gH, { defaultColor: t, rfId: i }), T.map((O) => F.jsx(wH, { id: O, edgesFocusable: w, edgesReconnectable: E, elementsSelectable: M, noPanClassName: o, onReconnect: s, onContextMenu: c, onMouseEnter: f, onMouseMove: g, onMouseLeave: h, onClick: y, reconnectRadius: p, onDoubleClick: m, onReconnectStart: b, onReconnectEnd: _, rfId: i, onError: S, edgeTypes: u, disableKeyboardA11y: A }, O))] });
}
...
function MH({ children: t }) {
  ...
  }, [r]), F.jsx("div", { ref: i, className: "react-flow__viewport xyflow__viewport react-flow__container", style: { transform: zA(u) }, children: t });
}
function qH(t) {
...
function HH({ containerStyle: t, style: r, type: i, component: u }) {
  ...
  return !(s && o && g) ? null : F.jsx("svg", { style: t, width: s, height: c, className: "react-flow__connectionline react-flow__container", children: F.jsx("g", { className: ct(["react-flow__connection", mM(f)]), children: F.jsx(xq, { style: r, type: i, CustomComponent: u, isValid: f }) }) });
}
const xq = ({ style: t, type: r = zr.Bezier, CustomComponent: i, isValid: u }) => {
  const { inProgress: o, from: s, fromNode: c, fromHandle: f, fromPosition: g, to: h, toNode: y, toHandle: p, toPosition: m, pointer: b } = zH();
  if (!o)
    return;
  if (i)
    return F.jsx(i, { connectionLineType: r, connectionLineStyle: t, fromNode: c, fromHandle: f, fromX: s.x, fromY: s.y, toX: h.x, toY: h.y, fromPosition: g, toPosition: m, connectionStatus: mM(u), toNode: y, toHandle: p, pointer: b });
  let _ = "";
  const A = {
    sourceX: s.x,
    sourceY: s.y,
  ...
  return F.jsx("path", { d: _, fill: "none", className: "react-flow__connection-path", style: t });
};
...
function Sq({ nodeTypes: t, edgeTypes: r, onInit: i, onNodeClick: u, onEdgeClick: o, onNodeDoubleClick: s, onEdgeDoubleClick: c, onNodeMouseEnter: f, onNodeMouseMove: g, onNodeMouseLeave: h, onNodeContextMenu: y, onSelectionContextMenu: p, onSelectionStart: m, onSelectionEnd: b, connectionLineType: _, connectionLineStyle: A, connectionLineComponent: w, connectionLineContainerStyle: E, selectionKeyCode: M, selectionOnDrag: S, selectionMode: T, multiSelectionKeyCode: O, panActivationKeyCode: C, zoomActivationKeyCode: R, deleteKeyCode: H, onlyRenderVisibleElements: B, elementsSelectable: X, defaultViewport: Y, translateExtent: J, minZoom: K, maxZoom: D, preventScrolling: G, defaultMarkerColor: N, zoomOnScroll: j, zoomOnPinch: Z, panOnScroll: Q, panOnScrollSpeed: le, panOnScrollMode: z, zoomOnDoubleClick: V, panOnDrag: ie, autoPanOnSelection: L, onPaneClick: I, onPaneMouseEnter: P, onPaneMouseMove: ae, onPaneMouseLeave: W, onPaneScroll: se, onPaneContextMenu: de, paneClickDistance: ve, nodeClickDistance: pe, onEdgeContextMenu: he, onEdgeMouseEnter: me, onEdgeMouseMove: ge, onEdgeMouseLeave: Ae, reconnectRadius: xe, onReconnect: Pe, onReconnectStart: tt, onReconnectEnd: xt, noDragClassName: gt, noWheelClassName: St, noPanClassName: Ze, disableKeyboardA11y: ke, nodeExtent: vt, rfId: Ct, viewport: Tt, onViewportChange: ft, nodesDraggable: tr }) {
  return DA(t), DA(r), BH(), qH(i), RH(Tt), F.jsx(W8, { onPaneClick: I, onPaneMouseEnter: P, onPaneMouseMove: ae, onPaneMouseLeave: W, onPaneContextMenu: de, onPaneScroll: se, paneClickDistance: ve, deleteKeyCode: H, selectionKeyCode: M, selectionOnDrag: S, selectionMode: T, onSelectionStart: m, onSelectionEnd: b, multiSelectionKeyCode: O, panActivationKeyCode: C, zoomActivationKeyCode: R, elementsSelectable: X, zoomOnScroll: j, zoomOnPinch: Z, zoomOnDoubleClick: V, panOnScroll: Q, panOnScrollSpeed: le, panOnScrollMode: z, panOnDrag: ie, autoPanOnSelection: L, defaultViewport: Y, translateExtent: J, minZoom: K, maxZoom: D, onSelectionContextMenu: p, preventScrolling: G, noDragClassName: gt, noWheelClassName: St, noPanClassName: Ze, disableKeyboardA11y: ke, onViewportChange: ft, isControlledViewport: !!Tt, children: F.jsxs(MH, { children: [F.jsx(TH, { edgeTypes: r, onEdgeClick: o, onEdgeDoubleClick: c, onReconnect: Pe, onReconnectStart: tt, onReconnectEnd: xt, onlyRenderVisibleElements: B, onEdgeContextMenu: he, onEdgeMouseEnter: me, onEdgeMouseMove: ge, onEdgeMouseLeave: Ae, reconnectRadius: xe, defaultMarkerColor: N, noPanClassName: Ze, disableKeyboardA11y: ke, rfId: Ct }), F.jsx(HH, { style: A, type: _, component: w, containerStyle: E }), F.jsx("div", { className: "react-flow__edgelabel-renderer" }), F.jsx(oH, { nodeTypes: t, onNodeClick: u, onNodeDoubleClick: s, onNodeMouseEnter: f, onNodeMouseMove: g, onNodeMouseLeave: h, onNodeContextMenu: y, nodeClickDistance: pe, onlyRenderVisibleElements: B, noPanClassName: Ze, noDragClassName: gt, disableKeyboardA11y: ke, nodeExtent: vt, rfId: Ct, nodesDraggable: tr }), F.jsx("div", { className: "react-flow__viewport-portal" })] }) });
}
Sq.displayName = "GraphView";
const jH = re.memo(Sq), UH = wM(), HA = ({ nodes: t, edges: r, defaultNodes: i, defaultEdges: u, width: o, height: s, fitView: c, fitViewOptions: f, minZoom: g = 0.5, maxZoom: h = 2, nodeOrigin: y, nodeExtent: p, zIndexMode: m = "basic" } = {}) => {
  const b = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), E = u ?? r ?? [], M = i ?? t ?? [], S = y ?? [0, 0], T = p ?? Ou;
  LM(A, w, E);
...
}, GH = ({ nodes: t, edges: r, defaultNodes: i, defaultEdges: u, width: o, height: s, fitView: c, fitViewOptions: f, minZoom: g, maxZoom: h, nodeOrigin: y, nodeExtent: p, zIndexMode: m }) => P6((b, _) => {
  async function A() {
  ...
  return {
    ...
    updateNodePositions: (w, E = !1) => {
      ...
      for (const [B, X] of w) {
        const Y = T.get(B), J = !!(Y != null && Y.expandParent && (Y != null && Y.parentId) && (X != null && X.position)), K = {
          id: B,
          type: "position",
          position: J ? {
    ...
    unselectNodesAndEdges: ({ nodes: w, edges: E } = {}) => {
      ...
      for (const Y of R) {
        if (!Y.selected)
          continue;
        const J = T.get(Y.id);
        J && (J.selected = !1), B.push(na(Y.id, !1));
      }
      const X = [];
      for (const Y of H)
...
function Eq({ initialNodes: t, initialEdges: r, defaultNodes: i, defaultEdges: u, initialWidth: o, initialHeight: s, initialMinZoom: c, initialMaxZoom: f, initialFitViewOptions: g, fitView: h, nodeOrigin: y, nodeExtent: p, zIndexMode: m, children: b }) {
  ...
  return F.jsx(W6, { value: _, children: F.jsx(A8, { children: F.jsx(G8, { children: b }) }) });
}
function VH({ children: t, nodes: r, edges: i, defaultNodes: u, defaultEdges: o, width: s, height: c, fitView: f, fitViewOptions: g, minZoom: h, maxZoom: y, nodeOrigin: p, nodeExtent: m, zIndexMode: b }) {
  return re.useContext(ys) ? F.jsx(F.Fragment, { children: t }) : F.jsx(Eq, { initialNodes: r, initialEdges: i, defaultNodes: u, defaultEdges: o, initialWidth: s, initialHeight: c, fitView: f, initialFitViewOptions: g, initialMinZoom: h, initialMaxZoom: y, nodeOrigin: p, nodeExtent: m, zIndexMode: b, children: t });
}
const YH = {
  width: "100%",
  height: "100%",
...
function wq({
  ...
  return F.jsxs("svg", { className: ct(["react-flow__background", h]), style: {
    ...g,
    ...ms,
    "--xy-background-color-props": f,
    "--xy-background-pattern-color-props": c
  }, ref: p, "data-testid": "rf__background", children: [F.jsx("pattern", { id: R, x: m[0] % M[0], y: m[1] % M[1], width: M[0], height: M[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${C[0]},-${C[1]})`, children: A ? F.jsx(QH, { radius: S / 2, className: y }) : F.jsx(IH, { dimensions: O, lineWidth: o, variant: r, className: y }) }), F.jsx("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${R})` })] });
}
...
function Mo({ children: t, className: r, ...i }) {
  return F.jsx("button", { type: "button", className: ct(["react-flow__controls-button", r]), ...i, children: t });
}
const tL = (t) => ({
...
function Aq({ style: t, showZoom: r = !0, showFitView: i = !0, showInteractive: u = !0, fitViewOptions: o, onZoomIn: s, onZoomOut: c, onFitView: f, onInteractiveChange: g, className: h, children: y, position: p = "bottom-left", orientation: m = "vertical", "aria-label": b }) {
  ...
  return F.jsxs(ps, { className: ct(["react-flow__controls", X, h]), position: p, style: t, "data-testid": "rf__controls", "aria-label": b ?? M["controls.ariaLabel"], children: [r && F.jsxs(F.Fragment, { children: [F.jsx(Mo, { onClick: C, className: "react-flow__controls-zoomin", title: M["controls.zoomIn.ariaLabel"], "aria-label": M["controls.zoomIn.ariaLabel"], disabled: E, children: F.jsx(FH, {}) }), F.jsx(Mo, { onClick: R, className: "react-flow__controls-zoomout", title: M["controls.zoomOut.ariaLabel"], "aria-label": M["controls.zoomOut.ariaLabel"], disabled: w, children: F.jsx(JH, {}) })] }), i && F.jsx(Mo, { className: "react-flow__controls-fitview", onClick: H, title: M["controls.fitView.ariaLabel"], "aria-label": M["controls.fitView.ariaLabel"], children: F.jsx(PH, {}) }), u && F.jsx(Mo, { className: "react-flow__controls-interactive", onClick: B, title: M["controls.interactive.ariaLabel"], "aria-label": M["controls.interactive.ariaLabel"], children: A ? F.jsx(eL, {}) : F.jsx(WH, {}) }), y] });
}
Aq.displayName = "Controls";
re.memo(Aq);
function nL({ id: t, x: r, y: i, width: u, height: o, style: s, color: c, strokeColor: f, strokeWidth: g, className: h, borderRadius: y, shapeRendering: p, selected: m, onClick: b }) {
  const { background: _, backgroundColor: A } = s || {}, w = c || _ || A;
  return F.jsx("rect", { className: ct(["react-flow__minimap-node", { selected: m }, h]), x: r, y: i, rx: y, ry: y, width: u, height: o, style: {
    fill: w,
    stroke: f,
    strokeWidth: g
...
function iL({
  ...
  const f = ze(aL, Je), g = yp(r), h = yp(t), y = yp(i), p = typeof window > "u" || window.chrome ? "crispEdges" : "geometricPrecision";
  return F.jsx(F.Fragment, { children: f.map((m) => (
    /*
     ...
     */
    F.jsx(lL, { id: m, nodeColorFunc: g, nodeStrokeColorFunc: h, nodeClassNameFunc: y, nodeBorderRadius: u, nodeStrokeWidth: o, NodeComponent: s, onClick: c, shapeRendering: p }, m)
  )) });
}
function uL({ id: t, nodeColorFunc: r, nodeStrokeColorFunc: i, nodeClassNameFunc: u, nodeBorderRadius: o, nodeStrokeWidth: s, shapeRendering: c, NodeComponent: f, onClick: g }) {
  const { node: h, x: y, y: p, width: m, height: b } = ze((_) => {
  ...
  return !h || h.hidden || !AM(h) ? null : F.jsx(f, { x: y, y: p, width: m, height: b, style: h.style, selected: !!h.selected, className: u(h), color: r(h), borderRadius: o, strokeColor: i(h), strokeWidth: s, shapeRendering: c, onClick: g, id: h.id });
}
const lL = re.memo(uL);
var oL = re.memo(iL);
...
function Tq({
  ...
  return F.jsx(ps, { position: m, style: {
    ...t,
  ...
  }, className: ct(["react-flow__minimap", r]), "data-testid": "rf__minimap", children: F.jsxs("svg", { width: G, height: N, viewBox: `${ie} ${L} ${I} ${P}`, className: "react-flow__minimap-svg", role: "img", "aria-labelledby": ae, ref: C, onClick: de, children: [pe && F.jsx("title", { id: ae, children: pe }), F.jsx(oL, { onClick: ve, nodeColor: u, nodeStrokeColor: i, nodeBorderRadius: s, nodeClassName: o, nodeStrokeWidth: c, nodeComponent: f }), F.jsx("path", { className: "react-flow__minimap-mask", d: `M${ie - V},${L - V}h${I + V * 2}v${P + V * 2}h${-I - V * 2}z
...
function pL({ nodeId: t, position: r, variant: i = hi.Handle, className: u, style: o = void 0, children: s, color: c, minWidth: f = 10, minHeight: g = 10, maxWidth: h = Number.MAX_VALUE, maxHeight: y = Number.MAX_VALUE, keepAspectRatio: p = !1, resizeDirection: m, autoScale: b = !0, shouldResize: _, onResizeStart: A, onResize: w, onResizeEnd: E }) {
  ...
  re.useEffect(() => {
    if (!(!O.current || !S))
      return H.current || (H.current = G6({
        ...
        nodeId: S,
        getStoreItems: () => {
          const { nodeLookup: Y, transform: J, snapGrid: K, snapToGrid: D, nodeOrigin: G, domNode: N } = T.getState();
          return {
            nodeLookup: Y,
            transform: J,
            snapGrid: K,
  ...
  const X = B.split("-");
  return F.jsx("div", { className: ct(["react-flow__resize-control", "nodrag", ...X, i, u]), ref: O, style: {
    ...o,
    scale: R,
...
function mL({ flat: t, selected: r, color: i, state: u }) {
  ...
  return /* @__PURE__ */ F.jsxs(
    "div",
    {
      ...
      title: t.label,
      children: [
        t.phase ? /* @__PURE__ */ F.jsx("div", { className: "nwf-node-phase", children: t.phase }) : null,
        /* @__PURE__ */ F.jsx("div", { className: "nwf-node-label", children: t.label }),
        o.length > 0 ? /* @__PURE__ */ F.jsx("div", { className: "nwf-node-badges", children: o.map((c) => /* @__PURE__ */ F.jsx("span", { className: "nwf-node-badge", children: c }, c)) }) : null
      ]
    }
  );
}
...
function _L(t, r, i = {}) {
  ...
  for (const y of t) h.setNode(y.id, { width: u, height: o });
  for (const y of r)
    y.source !== y.target && h.hasNode(y.source) && h.hasNode(y.target) && h.setEdge(y.source, y.target);
  M2.layout(h);
  for (const y of t) {
    const p = h.node(y.id);
    g[y.id] = p ? { x: p.x - u / 2, y: p.y - o / 2 } : { x: 0, y: 0 };
  }
  return g;
}
var xL = [
...
function SL(t) {
  ...
  return /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
    /* @__PURE__ */ F.jsx(gi, { type: "target", position: s ? _e.Top : _e.Left }),
    o ? o(r, { selected: c }) : /* @__PURE__ */ F.jsx(mL, { flat: r, selected: c, color: i, state: u }),
    /* @__PURE__ */ F.jsx(gi, { type: "source", position: s ? _e.Bottom : _e.Right })
  ] });
}
...
function wL({
  ...
  const [w, E] = re.useState(null), M = i !== void 0, S = M ? i : w, T = (y == null ? void 0 : y.direction) ?? (p ? "TB" : "LR"), O = T === "TB" || T === "BT", C = re.useMemo(
    () => ({ ...y, direction: T }),
    [y, T]
  ...
  return /* @__PURE__ */ F.jsx("div", { className: D, style: { width: "100%", height: "100%", ..._ }, children: /* @__PURE__ */ F.jsx(
    XH,
    {
      nodes: X,
      edges: Y,
      ...
      children: A ?? /* @__PURE__ */ F.jsx($H, {})
    }
  ) });
}
function AL(t) {
  return /* @__PURE__ */ F.jsx(Eq, { children: /* @__PURE__ */ F.jsx(wL, { ...t }) });
}
const TL = [
  "--color-cornflower",
  "--color-teal",
...
function ML() {
  if (Mq(), typeof document > "u")
    return [];
  const t = getComputedStyle(document.documentElement);
  return TL.map((r) => t.getPropertyValue(r).trim()).filter(Boolean);
}
...
function OL(t) {
  ...
  switch (u) {
    ...
    case "matrixed": {
      const b = ((h = t.matrixed_config) == null ? void 0 : h.delegators) ?? [], _ = ((y = t.matrixed_config) == null ? void 0 : y.prompt_variations) ?? [];
...
function zL(t) {
  ...
  for (const g of r) {
    ...
    const y = OL(g);
    i.push(...y.nodes), u.push(...y.edges), o.set(g.name, y.exit);
  }
  for (let g = 0; g < r.length - 1; g += 1) {
    const h = o.get(r[g].name) ?? r[g].name, y = r[g + 1].name;
    u.push({ id: `${h}->${y}`, source: h, target: y, kind: "seq" });
  }
...
function DL({
  ...
  const o = Mq(), s = ML(), { nodes: c, edges: f } = re.useMemo(() => zL(t), [t]), g = re.useMemo(() => ({ height: r }), [r]);
  return c.length ? /* @__PURE__ */ F.jsx("div", { className: u ?? "operator-workflow-canvas", style: g, children: /* @__PURE__ */ F.jsx(
    AL,
    {
      nodes: c,
      edges: f,
    ...
    t.key
  ) }) : /* @__PURE__ */ F.jsx("div", { className: "operator-workflow-empty", children: "This issue type defines no steps." });
}
function HL({
  entries: t,
  selected: r,
  ...
  return u ? /* @__PURE__ */ F.jsxs("div", { className: "workflow-explorer-error", children: [
    "Could not load this collection: ",
    u
  ] }) : t ? t.length === 0 ? /* @__PURE__ */ F.jsx("div", { className: "workflow-explorer-loading", children: "This collection defines no issue types." }) : /* @__PURE__ */ F.jsxs("div", { className: "workflow-explorer-body", children: [
    /* @__PURE__ */ F.jsx("nav", { className: "workflow-explorer-rail", "aria-label": "Issue types", children: /* @__PURE__ */ F.jsx("ul", { children: t.map((s) => /* @__PURE__ */ F.jsx("li", { children: /* @__PURE__ */ F.jsx(LL, { entry: s, selected: s.key === r, onSelect: o }) }, s.key)) }) }),
    /* @__PURE__ */ F.jsx("div", { className: "workflow-explorer-canvas", children: i ? /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
      /* @__PURE__ */ F.jsxs("h3", { className: "workflow-explorer-title", children: [
        i.name,
        " ",
        /* @__PURE__ */ F.jsx("code", { children: i.key })
      ] }),
      i.description && /* @__PURE__ */ F.jsx("p", { className: "workflow-explorer-description", children: i.description }),
      /* @__PURE__ */ F.jsx(DL, { issueType: i, vertical: !0 })
    ] }) : /* @__PURE__ */ F.jsx("div", { className: "workflow-explorer-loading", children: "Loading workflow…" }) })
  ] }) : /* @__PURE__ */ F.jsx("div", { className: "workflow-explorer-loading", children: "Loading collection…" });
}
function LL({
  entry: t,
  selected: r,
  ...
  return /* @__PURE__ */ F.jsx(
    "button",
    {
      type: "button",
      "aria-current": r,
      className: r ? "is-selected" : void 0,
      onClick: () => i(t.key),
      children: t.key
    }
  );
...
async function jA(t) {
  ...
  if (!r.ok)
    throw new Error(`${r.status} ${r.statusText} for ${t}`);
  return await r.json();
}
function BL({ base: t, initial: r }) {
  const [i, u] = re.useState(null), [o, s] = re.useState(r ?? null), [c, f] = re.useState(null), [g, h] = re.useState(null);
  re.useEffect(() => {
    let m = !1;
    return jA(`${t}collection.json`).then((b) => {
      if (!m) {
        const _ = b.issue_types ?? [];
        u(_), s((A) => {
          var w;
          return A ?? ((w = _[0]) == null ? void 0 : w.key) ?? null;
        });
      }
    }).catch((b) => !m && h(b.message)), () => {
      m = !0;
    };
  }, [t]), re.useEffect(() => {
    if (!i || !o)
      return;
    const m = i.find((_) => _.key === o);
    if (!m)
      return;
    let b = !1;
    return jA(`${t}${m.schema_path}`).then((_) => {
      b || f(_);
    }).catch((_) => !b && h(_.message)), () => {
      b = !0;
    };
  }, [t, i, o]);
  const y = re.useCallback((m) => {
    h(null), s(m);
  }, []), p = (c == null ? void 0 : c.key) === o ? c : null;
  return /* @__PURE__ */ F.jsx(
    HL,
    {
      entries: i,
...
class jL extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.root = KR.createRoot(this), this.root.render(
      /* @__PURE__ */ F.jsx(re.StrictMode, { children: /* @__PURE__ */ F.jsx(
        BL,
        {
          base: i.endsWith("/") ? i : `${i}/`,
...
const UL = "operator-workflow-explorer";
function Cq(t, r) {
...
export {
  ...
  jL as OperatorWorkflowExplorer
};
