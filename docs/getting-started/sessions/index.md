...
| Option | Status | Notes |
|--------|--------|-------|
| [VS Code Terminals](/getting-started/sessions/vscode-terminals/) | Beta | Integrated terminals controlled by the VS Code extension |
...
[IDE integrations](/getting-started/ides/) and [execution transports](/getting-started/transports/) are separate choices. A controller manages its own terminal environment: cmux cannot control terminals inside VS Code.
